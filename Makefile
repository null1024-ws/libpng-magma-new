...
am__append_9 = -DPNG_PREFIX='MAGMA_'
subdir = .
...
am_libpng_read_fuzzer_OBJECTS =  \
	contrib/oss-fuzz/libpng_read_fuzzer.$(OBJEXT) \
	contrib/oss-fuzz/afl_driver.$(OBJEXT)
libpng_read_fuzzer_OBJECTS = $(am_libpng_read_fuzzer_OBJECTS)
am__DEPENDENCIES_1 =
libpng_read_fuzzer_DEPENDENCIES =  \
	libpng16.la $(am__DEPENDENCIES_1)
...
SOURCES = $(libpng16_la_SOURCES) \
	...
	$(libpng_read_fuzzer_SOURCES) $(png_fix_itxt_SOURCES) \
	$(pngcp_SOURCES) $(pngfix_SOURCES) $(pngimage_SOURCES) \
	$(pngstest_SOURCES) $(pngtest_SOURCES) $(pngunknown_SOURCES) \
	$(pngvalid_SOURCES) $(timepng_SOURCES)
DIST_SOURCES =  \
...
ACLOCAL = ${SHELL} /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo/missing autoconf
AUTOHEADER = ${SHELL} /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo/missing autoheader
AUTOMAKE = ${SHELL} /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo/missing automake-1.15
AWK = gawk
CC = /data/sda_18tdisk/morangeous/Fuzzing/multi-dafl-code/DAFL/afl-clang-fast
CCAS = /data/sda_18tdisk/morangeous/Fuzzing/multi-dafl-code/DAFL/afl-clang-fast
CCASDEPMODE = depmode=gcc3
CCASFLAGS = -g -fno-omit-frame-pointer -fcommon -Wno-error -fsanitize=address
CCDEPMODE = depmode=gcc3
CFLAGS = -g -fno-omit-frame-pointer -fcommon -Wno-error -fsanitize=address
CPP = /data/sda_18tdisk/morangeous/Fuzzing/multi-dafl-code/DAFL/afl-clang-fast -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
DFNCPP = /data/sda_18tdisk/morangeous/Fuzzing/multi-dafl-code/DAFL/afl-clang-fast -E
DLLTOOL = false
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
SYMBOL_PREFIX = 
VERSION = 1.6.38.git
abs_builddir = /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo
abs_srcdir = /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo
abs_top_builddir = /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo
abs_top_srcdir = /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo
ac_ct_AR = ar
ac_ct_CC = /data/sda_18tdisk/morangeous/Fuzzing/multi-dafl-code/DAFL/afl-clang-fast
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /data/sda_18tdisk/morangeous/Fuzzing/whole-pipeline/data/libpng-all-trgts/source-code/libpng/repo/install-sh
...
libpng_read_fuzzer_SOURCES = contrib/oss-fuzz/libpng_read_fuzzer.c contrib/oss-fuzz/afl_driver.c
libpng_read_fuzzer_LDADD = libpng16.la $(LIBS) -lz
...
# we have seen.
EXT_LIST = a dll.a so so.16.38 la sl dylib
...
clean-checkPROGRAMS:
	...
	echo " rm -f" $$list; \
	rm -f $$list
contrib/oss-fuzz/$(am__dirstamp):
	@$(MKDIR_P) contrib/oss-fuzz
	@: > contrib/oss-fuzz/$(am__dirstamp)
contrib/oss-fuzz/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) contrib/oss-fuzz/$(DEPDIR)
	@: > contrib/oss-fuzz/$(DEPDIR)/$(am__dirstamp)
contrib/oss-fuzz/libpng_read_fuzzer.$(OBJEXT):  \
	contrib/oss-fuzz/$(am__dirstamp) \
	contrib/oss-fuzz/$(DEPDIR)/$(am__dirstamp)
...
libpng-read-fuzzer$(EXEEXT): $(libpng_read_fuzzer_OBJECTS) $(libpng_read_fuzzer_DEPENDENCIES) $(EXTRA_libpng_read_fuzzer_DEPENDENCIES) 
	@rm -f libpng-read-fuzzer$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(libpng_read_fuzzer_OBJECTS) $(libpng_read_fuzzer_LDADD) $(LIBS)
...
include arm/$(DEPDIR)/palette_neon_intrinsics.Plo
...
include contrib/oss-fuzz/$(DEPDIR)/afl_driver.Po
include contrib/oss-fuzz/$(DEPDIR)/libpng_read_fuzzer.Po
...
distclean-generic:
	...
	-rm -f contrib/oss-fuzz/$(DEPDIR)/$(am__dirstamp)
	-rm -f contrib/oss-fuzz/$(am__dirstamp)
...
distclean: distclean-am
	...
	-rm -rf ./$(DEPDIR) arm/$(DEPDIR) contrib/libtests/$(DEPDIR) contrib/oss-fuzz/$(DEPDIR) contrib/tools/$(DEPDIR) intel/$(DEPDIR) mips/$(DEPDIR) powerpc/$(DEPDIR)
	-rm -f Makefile
...
pnglibconf.h: pnglibconf.out scripts/prefix.out scripts/macro.lst
	...
	$(AWK) 's==0 && NR>1{print prev}\
	   s==0{prev=$$0}\
	   s==1{print "#define", $$1, "MAGMA_" $$1}\
	   s==2{print "#define MAGMA_png_" $$1, "PNG_" $$1}\
...
pngprefix.h: scripts/intprefix.out
	rm -f pngprefix.tf1
	$(AWK) '{print "#define", $$1, "MAGMA_" $$1}' $? >pngprefix.tf1
	mv pngprefix.tf1 $@
...
scripts/pnglibconf.c: scripts/pnglibconf.dfa scripts/options.awk pngconf.h
	...
	test -z "$(CPPFLAGS)"
	echo "com 1.6.38.git STANDARD API DEFINITION" |\
