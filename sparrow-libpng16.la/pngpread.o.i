# 1 "/benchmark/project/libpng/repo/pngpread.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngpread.c" 2
# 14 "/benchmark/project/libpng/repo/pngpread.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 15 "/benchmark/project/libpng/repo/pngpread.c" 2
# 35 "/benchmark/project/libpng/repo/pngpread.c"
void
MAGMA_png_process_data(png_structrp png_ptr, png_inforp info_ptr,
    png_bytep buffer, size_t buffer_size)
{
   if (png_ptr == ((void*)0) || info_ptr == ((void*)0))
      return;

   MAGMA_png_push_restore_buffer(png_ptr, buffer, buffer_size);

   while (png_ptr->buffer_size)
   {
      MAGMA_png_process_some_data(png_ptr, info_ptr);
   }
}

size_t
MAGMA_png_process_data_pause(png_structrp png_ptr, int save)
{
   if (png_ptr != ((void*)0))
   {
      ...
      if (save != 0)
         MAGMA_png_push_save_buffer(png_ptr);
      else
      {
...
png_uint_32
MAGMA_png_process_data_skip(png_structrp png_ptr)
{
...
void
MAGMA_png_process_some_data(png_structrp png_ptr, png_inforp info_ptr)
{
   if (png_ptr == ((void*)0))
      return;
   ...
   switch (png_ptr->process_mode)
   {
      case 0:
      {
         MAGMA_png_push_read_sig(png_ptr, info_ptr);
         break;
      }

      case 1:
      {
         MAGMA_png_push_read_chunk(png_ptr, info_ptr);
         break;
      }

      case 2:
      {
         MAGMA_png_push_read_IDAT(png_ptr);
         break;
      }
...
void
MAGMA_png_push_read_sig(png_structrp png_ptr, png_inforp info_ptr)
{
   ...
   MAGMA_png_push_fill_buffer(png_ptr, &(info_ptr->signature[num_checked]),
       num_to_check);
   png_ptr->sig_bytes = (png_byte)(png_ptr->sig_bytes + num_to_check);

   if (MAGMA_png_sig_cmp(info_ptr->signature, num_checked, num_to_check))
   {
      if (num_checked < 4 &&
...
void
MAGMA_png_push_read_chunk(png_structrp png_ptr, png_inforp info_ptr)
{
   png_uint_32 chunk_name;

   int keep;
# 180 "/benchmark/project/libpng/repo/pngpread.c"
   if ((png_ptr->mode & 0x100U) == 0)
   {
      png_byte chunk_length[4];
      png_byte chunk_tag[4];

      if (png_ptr->buffer_size < 8) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_push_fill_buffer(png_ptr, chunk_length, 4);
      png_ptr->push_length = MAGMA_png_get_uint_31(png_ptr, chunk_length);
      MAGMA_png_reset_crc(png_ptr);
      MAGMA_png_crc_read(png_ptr, chunk_tag, 4);
      ...
      MAGMA_png_check_chunk_length(png_ptr, png_ptr->push_length);
      png_ptr->mode |= 0x100U;
   }
   ...
   if (chunk_name == (((png_uint_32)(73) << (24)) | ((png_uint_32)(68) << (16)) | ((png_uint_32)(65) << (8)) | ((png_uint_32)(84) << (0))))
   {
      ...
      if ((png_ptr->mode & 0x01) == 0)
         MAGMA_png_error(png_ptr, "Missing IHDR before IDAT");

      else if (png_ptr->color_type == (2 | 1) &&
          (png_ptr->mode & 0x02) == 0)
         MAGMA_png_error(png_ptr, "Missing PLTE before IDAT");

      png_ptr->process_mode = 2;

      if ((png_ptr->mode & 0x04U) != 0)
         if ((png_ptr->mode & 0x2000U) == 0)
   ...
   if (chunk_name == (((png_uint_32)(73) << (24)) | ((png_uint_32)(72) << (16)) | ((png_uint_32)(68) << (8)) | ((png_uint_32)(82) << (0))))
   {
      if (png_ptr->push_length != 13)
         MAGMA_png_error(png_ptr, "Invalid IHDR length");

      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_IHDR(png_ptr, info_ptr, png_ptr->push_length);
   }

   else if (chunk_name == (((png_uint_32)(73) << (24)) | ((png_uint_32)(69) << (16)) | ((png_uint_32)(78) << (8)) | ((png_uint_32)(68) << (0))))
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_IEND(png_ptr, info_ptr, png_ptr->push_length);

      png_ptr->process_mode = 6;
      MAGMA_png_push_have_end(png_ptr, info_ptr);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_unknown(png_ptr, info_ptr, png_ptr->push_length, keep);
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_PLTE(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   else if (chunk_name == (((png_uint_32)(73) << (24)) | ((png_uint_32)(68) << (16)) | ((png_uint_32)(65) << (8)) | ((png_uint_32)(84) << (0))))
   {
      ...
      png_ptr->process_mode = 2;
      MAGMA_png_push_have_info(png_ptr, info_ptr);
      png_ptr->zstream.avail_out =
          (uInt) ((png_ptr->pixel_depth) >= 8 ? ((size_t)(png_ptr->iwidth) * (((size_t)(png_ptr->pixel_depth)) >> 3)) : (( ((size_t)(png_ptr->iwidth) * ((size_t)(png_ptr->pixel_depth))) + 7) >> 3) ) + 1;
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_gAMA(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_sBIT(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_cHRM(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_sRGB(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_iCCP(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_sPLT(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_tRNS(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_bKGD(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_hIST(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_pHYs(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_oFFs(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_pCAL(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_sCAL(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_tIME(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_tEXt(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_zTXt(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_iTXt(png_ptr, info_ptr, png_ptr->push_length);
   }
   ...
   {
      if (png_ptr->push_length + 4 > png_ptr->buffer_size) { MAGMA_png_push_save_buffer(png_ptr); return; }
      MAGMA_png_handle_unknown(png_ptr, info_ptr, png_ptr->push_length,
          0);
   }
...
void
MAGMA_png_push_fill_buffer(png_structp png_ptr, png_bytep buffer, size_t length)
{
   png_bytep ptr;
...
void
MAGMA_png_push_save_buffer(png_structrp png_ptr)
{
   if (png_ptr->save_buffer_size != 0)
   {
       ...
       png_ptr->save_buffer_max)
   {
      ...
      if (png_ptr->save_buffer_size > ((size_t)(-1)) -
          (png_ptr->current_buffer_size + 256))
      {
         MAGMA_png_error(png_ptr, "Potential overflow of save_buffer");
      }

      new_max = png_ptr->save_buffer_size + png_ptr->current_buffer_size + 256;
      old_buffer = png_ptr->save_buffer;
      png_ptr->save_buffer = (png_bytep)MAGMA_png_malloc_warn(png_ptr,
          (size_t)new_max);

      if (png_ptr->save_buffer == ((void*)0))
      {
         MAGMA_png_free(png_ptr, old_buffer);
         MAGMA_png_error(png_ptr, "Insufficient memory for save_buffer");
      }

      if (old_buffer)
         memcpy(png_ptr->save_buffer, old_buffer, png_ptr->save_buffer_size);
      else if (png_ptr->save_buffer_size)
         MAGMA_png_error(png_ptr, "save_buffer error");
      MAGMA_png_free(png_ptr, old_buffer);
...
void
MAGMA_png_push_restore_buffer(png_structrp png_ptr, png_bytep buffer,
...
void
MAGMA_png_push_read_IDAT(png_structrp png_ptr)
{
   if ((png_ptr->mode & 0x100U) == 0)
   {
      png_byte chunk_length[4];
      ...
      if (png_ptr->chunk_name != (((png_uint_32)(73) << (24)) | ((png_uint_32)(68) << (16)) | ((png_uint_32)(65) << (8)) | ((png_uint_32)(84) << (0))))
      {
         ...
         if ((png_ptr->flags & 0x0008U) == 0)
            MAGMA_png_error(png_ptr, "Not enough compressed data");
   ...
   if (png_ptr->idat_size != 0 && png_ptr->save_buffer_size != 0)
   {
      ...
      MAGMA_png_calculate_crc(png_ptr, png_ptr->save_buffer_ptr, save_size);

      MAGMA_png_process_IDAT_data(png_ptr, png_ptr->save_buffer_ptr, save_size);
   ...
   if (png_ptr->idat_size != 0 && png_ptr->current_buffer_size != 0)
   {
      ...
      MAGMA_png_calculate_crc(png_ptr, png_ptr->current_buffer_ptr, save_size);

      MAGMA_png_process_IDAT_data(png_ptr, png_ptr->current_buffer_ptr, save_size);
   ...
   {
      if (png_ptr->buffer_size < 4) { MAGMA_png_push_save_buffer(png_ptr); return; }
...
void
MAGMA_png_process_IDAT_data(png_structrp png_ptr, png_bytep buffer,
    size_t buffer_length)
{

   if (!(buffer_length > 0) || buffer == ((void*)0))
      MAGMA_png_error(png_ptr, "No IDAT data (internal error)");
      ...
      (png_ptr->flags & 0x0008U) == 0)
   {
      ...
      if (!(png_ptr->zstream.avail_out > 0))
      {
         ...
         png_ptr->zstream.avail_out = (uInt)(((png_ptr->pixel_depth) >= 8 ? ((size_t)(png_ptr->iwidth) * (((size_t)(png_ptr->pixel_depth)) >> 3)) : (( ((size_t)(png_ptr->iwidth) * ((size_t)(png_ptr->pixel_depth))) + 7) >> 3) ) + 1);


         png_ptr->zstream.next_out = png_ptr->row_buf;
      }
# 671 "/benchmark/project/libpng/repo/pngpread.c"
      ret = MAGMA_png_zlib_inflate(png_ptr, 2);
      ...
      if (ret != 0 && ret != 1)
      {
         ...
         if (png_ptr->row_number >= png_ptr->num_rows ||
             png_ptr->pass > 6)
            MAGMA_png_warning(png_ptr, "Truncated compressed data in IDAT");

         else
         {
            if (ret == (-3))
               MAGMA_png_benign_error(png_ptr, "IDAT: ADLER32 checksum mismatch");
            else
               MAGMA_png_error(png_ptr, "Decompression error in IDAT");
         }
      ...
      if (png_ptr->zstream.next_out != png_ptr->row_buf)
      {
             ...
             png_ptr->pass > 6)
         {
            ...
            MAGMA_png_warning(png_ptr, "Extra compressed data in IDAT");
            png_ptr->flags |= 0x0008U;
            png_ptr->zowner = 0;
         ...
         if (png_ptr->zstream.avail_out == 0)
            MAGMA_png_push_process_row(png_ptr);
      }
   ...
   if (png_ptr->zstream.avail_in > 0)
      MAGMA_png_warning(png_ptr, "Extra compression data in IDAT");
}

void
MAGMA_png_push_process_row(png_structrp png_ptr)
{
   ...
   if (png_ptr->transformed_pixel_depth == 0)
   {
      ...
      if (row_info.pixel_depth > png_ptr->maximum_pixel_depth)
         MAGMA_png_error(png_ptr, "progressive row overflow");
   }

   else if (png_ptr->transformed_pixel_depth != row_info.pixel_depth)
      MAGMA_png_error(png_ptr, "internal progressive row size calculation error");
       ...
       (png_ptr->transformations & 0x0002U) != 0)
   {
      ...
      switch (png_ptr->pass)
      {
         case 0:
         {
            ...
            {
               MAGMA_png_push_have_row(png_ptr, png_ptr->row_buf + 1);
               MAGMA_png_read_push_finish_row(png_ptr);
            }
            ...
            if (png_ptr->pass == 2)
            {
               ...
               {
                  MAGMA_png_push_have_row(png_ptr, ((void*)0));
                  MAGMA_png_read_push_finish_row(png_ptr);
               }
            }
...
void
MAGMA_png_read_push_finish_row(png_structrp png_ptr)
{
...
void
MAGMA_png_push_have_info(png_structrp png_ptr, png_inforp info_ptr)
{
...
void
MAGMA_png_push_have_end(png_structrp png_ptr, png_inforp info_ptr)
{
...
void
MAGMA_png_push_have_row(png_structrp png_ptr, png_bytep row)
{
...
void
MAGMA_png_progressive_combine_row(png_const_structrp png_ptr, png_bytep old_row,
    png_const_bytep new_row)
{
   ...
   if (new_row != ((void*)0))
      MAGMA_png_combine_row(png_ptr, old_row, 1 );
}


void
MAGMA_png_set_progressive_read_fn(png_structrp png_ptr, png_voidp progressive_ptr,
    ...
    png_progressive_end_ptr end_fn)
{
   ...
   MAGMA_png_set_read_fn(png_ptr, progressive_ptr, MAGMA_png_push_fill_buffer);
}

png_voidp
MAGMA_png_get_progressive_ptr(png_const_structrp png_ptr)
{
   if (png_ptr == ((void*)0))
      return (((void*)0));
