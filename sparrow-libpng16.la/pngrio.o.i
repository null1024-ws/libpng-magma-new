# 1 "/benchmark/project/libpng/repo/pngrio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngrio.c" 2
# 21 "/benchmark/project/libpng/repo/pngrio.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 22 "/benchmark/project/libpng/repo/pngrio.c" 2
# 31 "/benchmark/project/libpng/repo/pngrio.c"
void
MAGMA_png_read_data(png_structrp png_ptr, png_bytep data, size_t length)
{
   ((void)0);
   ...
   if (png_ptr->read_data_fn != ((void*)0))
      ...
      MAGMA_png_error(png_ptr, "Call to NULL read function");
}
...
void
MAGMA_png_default_read_data(png_structp png_ptr, png_bytep data, size_t length)
{
   size_t check;
...
# 86 "/benchmark/project/libpng/repo/pngrio.c"
void
MAGMA_png_set_read_fn(png_structrp png_ptr, png_voidp io_ptr,
    png_rw_ptr read_data_fn)
{
   if (png_ptr == ((void*)0))
      return;
   ...
   if (read_data_fn != ((void*)0))
      ...
      png_ptr->read_data_fn = MAGMA_png_default_read_data;
