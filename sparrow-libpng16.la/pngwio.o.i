# 1 "/benchmark/project/libpng/repo/pngwio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngwio.c" 2
# 21 "/benchmark/project/libpng/repo/pngwio.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 22 "/benchmark/project/libpng/repo/pngwio.c" 2
# 32 "/benchmark/project/libpng/repo/pngwio.c"
void
MAGMA_png_write_data(png_structrp png_ptr, png_const_bytep data, size_t length)
{

   if (png_ptr->write_data_fn != ((void*)0) )
      (*(png_ptr->write_data_fn))(png_ptr, ((png_bytep)(png_ptruint)(const void*)(data)),
          length);

   else
      MAGMA_png_error(png_ptr, "Call to NULL write function");
}
...
void
MAGMA_png_default_write_data(png_structp png_ptr, png_bytep data, size_t length)
{
   size_t check;
   ...
   if (check != length)
      MAGMA_png_error(png_ptr, "Write Error");
}
...
void
MAGMA_png_flush(png_structrp png_ptr)
{
...
void
MAGMA_png_default_flush(png_structp png_ptr)
{
   png_FILE_p io_ptr;
...
# 121 "/benchmark/project/libpng/repo/pngwio.c"
void
MAGMA_png_set_write_fn(png_structrp png_ptr, png_voidp io_ptr,
    png_rw_ptr write_data_fn, png_flush_ptr output_flush_fn)
{
   ...
   if (write_data_fn != ((void*)0))
      ...
      png_ptr->write_data_fn = MAGMA_png_default_write_data;
   ...
   if (output_flush_fn != ((void*)0))
      ...
      png_ptr->output_flush_fn = MAGMA_png_default_flush;
# 158 "/benchmark/project/libpng/repo/pngwio.c"
