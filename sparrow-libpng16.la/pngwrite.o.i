# 1 "/benchmark/project/libpng/repo/pngwrite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngwrite.c" 2
# 14 "/benchmark/project/libpng/repo/pngwrite.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 15 "/benchmark/project/libpng/repo/pngwrite.c" 2
...
# 17 "/benchmark/project/libpng/repo/pngwrite.c" 2
    ...
    unsigned int where)
{
   if (info_ptr->unknown_chunks_num != 0)
   {
         ...
         if ((up->location & where) != 0)
      {
         ...
         int keep = MAGMA_png_handle_as_unknown(png_ptr, up->name);
# 56 "/benchmark/project/libpng/repo/pngwrite.c"
         if (keep != 1 &&
             ((up->name[3] & 0x20) ||
              keep == 3 ||
              (keep == 0 &&
...

         {
            ...
            if (up->size == 0)
               MAGMA_png_warning(png_ptr, "Writing zero-length unknown chunk");

            MAGMA_png_write_chunk(png_ptr, up->name, up->data, up->size);
         }
      }
   }
}
# 83 "/benchmark/project/libpng/repo/pngwrite.c"
void
MAGMA_png_write_info_before_PLTE(png_structrp png_ptr, png_const_inforp info_ptr)
{
   ((void)0);
   ...
   if ((png_ptr->mode & 0x400U) == 0)
   {
      ...
      MAGMA_png_write_sig(png_ptr);


      if ((png_ptr->mode & 0x1000U) != 0 && png_ptr->mng_features_permitted != 0)
      ...
      MAGMA_png_write_IHDR(png_ptr, info_ptr->width, info_ptr->height,
...
# 133 "/benchmark/project/libpng/repo/pngwrite.c"
      if ((info_ptr->colorspace.flags & 0x8000) == 0 &&
          (info_ptr->colorspace.flags & 0x0008) != 0 &&
          (info_ptr->valid & 0x0001U) != 0)
         MAGMA_png_write_gAMA_fixed(png_ptr, info_ptr->colorspace.gamma);
# 145 "/benchmark/project/libpng/repo/pngwrite.c"
         if ((info_ptr->colorspace.flags & 0x8000) == 0 &&
             (info_ptr->valid & 0x1000U) != 0)
         {

               if ((info_ptr->valid & 0x0800U) != 0)
                  MAGMA_png_app_warning(png_ptr,
                      "profile matches sRGB but writing iCCP instead");


            MAGMA_png_write_iCCP(png_ptr, info_ptr->iccp_name,
         ...
         if ((info_ptr->colorspace.flags & 0x8000) == 0 &&
             (info_ptr->valid & 0x0800U) != 0)
            MAGMA_png_write_sRGB(png_ptr, info_ptr->colorspace.rendering_intent);




         if ((info_ptr->valid & 0x0002U) != 0)
            MAGMA_png_write_sBIT(png_ptr, &(info_ptr->sig_bit), info_ptr->color_type);




         if ((info_ptr->colorspace.flags & 0x8000) == 0 &&
             (info_ptr->colorspace.flags & 0x0010) != 0 &&
             (info_ptr->valid & 0x0004U) != 0)
            MAGMA_png_write_cHRM_fixed(png_ptr, &info_ptr->colorspace.end_points_xy);
...
void
MAGMA_png_write_info(png_structrp png_ptr, png_const_inforp info_ptr)
{
   ...
   MAGMA_png_write_info_before_PLTE(png_ptr, info_ptr);

   if ((info_ptr->valid & 0x0008U) != 0)
      MAGMA_png_write_PLTE(png_ptr, info_ptr->palette,
          (png_uint_32)info_ptr->num_palette);

   else if (info_ptr->color_type == (2 | 1))
      MAGMA_png_error(png_ptr, "Valid palette required for paletted images");
   ...
   if ((info_ptr->valid & 0x0010U) !=0)
   {
      ...
      MAGMA_png_write_tRNS(png_ptr, info_ptr->trans_alpha, &(info_ptr->trans_color),
          info_ptr->num_trans, info_ptr->color_type);
   }


   if ((info_ptr->valid & 0x0020U) != 0)
      MAGMA_png_write_bKGD(png_ptr, &(info_ptr->background), info_ptr->color_type);



   if ((info_ptr->valid & 0x10000U) != 0)
      MAGMA_png_write_eXIf(png_ptr, info_ptr->exif, info_ptr->num_exif);



   if ((info_ptr->valid & 0x0040U) != 0)
      MAGMA_png_write_hIST(png_ptr, info_ptr->hist, info_ptr->num_palette);



   if ((info_ptr->valid & 0x0100U) != 0)
      MAGMA_png_write_oFFs(png_ptr, info_ptr->x_offset, info_ptr->y_offset,
          info_ptr->offset_unit_type);



   if ((info_ptr->valid & 0x0400U) != 0)
      MAGMA_png_write_pCAL(png_ptr, info_ptr->pcal_purpose, info_ptr->pcal_X0,
          info_ptr->pcal_X1, info_ptr->pcal_type, info_ptr->pcal_nparams,
          info_ptr->pcal_units, info_ptr->pcal_params);



   if ((info_ptr->valid & 0x4000U) != 0)
      MAGMA_png_write_sCAL_s(png_ptr, (int)info_ptr->scal_unit,
          info_ptr->scal_s_width, info_ptr->scal_s_height);



   if ((info_ptr->valid & 0x0080U) != 0)
      MAGMA_png_write_pHYs(png_ptr, info_ptr->x_pixels_per_unit,
          info_ptr->y_pixels_per_unit, info_ptr->phys_unit_type);



   if ((info_ptr->valid & 0x0200U) != 0)
   {
      MAGMA_png_write_tIME(png_ptr, &(info_ptr->mod_time));
      png_ptr->mode |= 0x200U;
   }



   if ((info_ptr->valid & 0x2000U) != 0)
      for (i = 0; i < (int)info_ptr->splt_palettes_num; i++)
         MAGMA_png_write_sPLT(png_ptr, info_ptr->splt_palettes + i);
   ...
   for (i = 0; i < info_ptr->num_text; i++)
   {
      ...
      else if (info_ptr->text[i].compression == 0)
      {
         ...
         MAGMA_png_write_zTXt(png_ptr, info_ptr->text[i].key,
      ...
      else if (info_ptr->text[i].compression == -1)
      {
         ...
         MAGMA_png_write_tEXt(png_ptr, info_ptr->text[i].key,
             info_ptr->text[i].text,
             0);
...
void
MAGMA_png_write_end(png_structrp png_ptr, png_inforp info_ptr)
{
   ((void)0);
   ...
   if ((png_ptr->mode & 0x04U) == 0)
      MAGMA_png_error(png_ptr, "No IDATs written into file");


   if (png_ptr->num_palette_max > png_ptr->num_palette)
      MAGMA_png_benign_error(png_ptr, "Wrote palette index exceeding num_palette");
   ...
   MAGMA_png_write_IEND(png_ptr);
# 463 "/benchmark/project/libpng/repo/pngwrite.c"
}


void
MAGMA_png_convert_from_struct_tm(png_timep ptime, const struct tm * ttime)
{
   ((void)0);
...
void
MAGMA_png_convert_from_time_t(png_timep ptime, time_t ttime)
{
   struct tm *tbuf;
   ...
   tbuf = gmtime(&ttime);
   MAGMA_png_convert_from_struct_tm(ptime, tbuf);
}



__attribute__((__malloc__)) png_structp MAGMA_png_create_write_struct (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn, png_error_ptr warn_fn)
...

{
   ...
   return MAGMA_png_create_write_struct_2(user_png_ver, error_ptr, error_fn,
       warn_fn, ((void*)0), ((void*)0), ((void*)0));
}


__attribute__((__malloc__)) png_structp MAGMA_png_create_write_struct_2 (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn, png_error_ptr warn_fn, png_voidp mem_ptr, png_malloc_ptr malloc_fn, png_free_ptr free_fn)



{
   png_structrp png_ptr = MAGMA_png_create_png_struct(user_png_ver, error_ptr,
...
# 561 "/benchmark/project/libpng/repo/pngwrite.c"
      MAGMA_png_set_write_fn(png_ptr, ((void*)0), ((void*)0), ((void*)0));
   }
...
void
MAGMA_png_write_rows(png_structrp png_ptr, png_bytepp row,
    png_uint_32 num_rows)
{
   png_uint_32 i;
   png_bytepp rp;
   ...
   {
      MAGMA_png_write_row(png_ptr, *rp);
   }
}
...
void
MAGMA_png_write_image(png_structrp png_ptr, png_bytepp image)
{
   png_uint_32 i;
   int pass, num_pass;
   png_bytepp rp;
   ...
   num_pass = MAGMA_png_set_interlace_handling(png_ptr);
...
void
MAGMA_png_write_row(png_structrp png_ptr, png_const_bytep row)
{
...
# 749 "/benchmark/project/libpng/repo/pngwrite.c"
      MAGMA_png_write_start_row(png_ptr);
   }
       ...
       (png_ptr->transformations & 0x0002U) != 0)
   {
      switch (png_ptr->pass)
      {
         case 0:
            ...
            {
               MAGMA_png_write_finish_row(png_ptr);
               return;
            }
            break;
   ...
   if (png_ptr->interlaced && png_ptr->pass < 6 &&
       (png_ptr->transformations & 0x0002U) != 0)
   {
      MAGMA_png_do_write_interlace(&row_info, png_ptr->row_buf + 1, png_ptr->pass);
   ...
   if (png_ptr->transformations != 0)
      MAGMA_png_do_write_transformations(png_ptr, &row_info);
   ...
   if (row_info.pixel_depth != png_ptr->pixel_depth ||
      ...
      MAGMA_png_error(png_ptr, "internal write transform logic error");
# 877 "/benchmark/project/libpng/repo/pngwrite.c"
   ...
   MAGMA_png_write_find_filter(png_ptr, &row_info);
...
void
MAGMA_png_set_flush(png_structrp png_ptr, int nrows)
{
   ((void)0);
...
void
MAGMA_png_write_flush(png_structrp png_ptr)
{
   ((void)0);
   ...
   MAGMA_png_compress_IDAT(png_ptr, ((void*)0), 0, 2);
   png_ptr->flush_rows = 0;
   MAGMA_png_flush(png_ptr);
}
...
png_write_destroy(png_structrp png_ptr)
{
   ...
   MAGMA_png_free_buffer_list(png_ptr, &png_ptr->zbuffer_list);
   MAGMA_png_free(png_ptr, png_ptr->row_buf);
   png_ptr->row_buf = ((void*)0);

   MAGMA_png_free(png_ptr, png_ptr->prev_row);
   MAGMA_png_free(png_ptr, png_ptr->try_row);
   MAGMA_png_free(png_ptr, png_ptr->tst_row);
...
# 973 "/benchmark/project/libpng/repo/pngwrite.c"
void
MAGMA_png_destroy_write_struct(png_structpp png_ptr_ptr, png_infopp info_ptr_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_filter(png_structrp png_ptr, int method, int filters)
{
   ((void)0);
   ...
   if (method == 0)
   {
      switch (filters & (((0x08 | 0x10 | 0x20) | 0x40 | 0x80) | 0x07))
      {
         ...
         case 5:
         case 6:
         case 7: MAGMA_png_app_error(png_ptr, "Unknown row filter for method 0");
...
# 1056 "/benchmark/project/libpng/repo/pngwrite.c"
      if (png_ptr->row_buf != ((void*)0))
      {
         ...
         if (png_ptr->try_row == ((void*)0))
            png_ptr->try_row = (MAGMA_png_malloc(png_ptr, buf_size));


         if (num_filters > 1)
         {
            if (png_ptr->tst_row == ((void*)0))
               png_ptr->tst_row = (MAGMA_png_malloc(png_ptr, buf_size));
      ...
      MAGMA_png_error(png_ptr, "Unknown custom filter method");
}
...
void
MAGMA_png_set_filter_heuristics(png_structrp png_ptr, int heuristic_method,
    int num_weights, png_const_doublep filter_weights,
    png_const_doublep filter_costs)
{
   (void)png_ptr;
   (void)heuristic_method;
   (void)num_weights;
   (void)filter_weights;
   (void)filter_costs;
}
...
void
MAGMA_png_set_filter_heuristics_fixed(png_structrp png_ptr, int heuristic_method,
...
void
MAGMA_png_set_compression_level(png_structrp png_ptr, int level)
{
   ((void)0);
...
void
MAGMA_png_set_compression_mem_level(png_structrp png_ptr, int mem_level)
{
   ((void)0);
...
void
MAGMA_png_set_compression_strategy(png_structrp png_ptr, int strategy)
{
   ((void)0);
...
void
MAGMA_png_set_compression_window_bits(png_structrp png_ptr, int window_bits)
{
   if (png_ptr == ((void*)0))
      return;
   ...
   if (window_bits > 15)
   {
      MAGMA_png_warning(png_ptr, "Only compression windows <= 32k supported by PNG");
      window_bits = 15;
   }

   else if (window_bits < 8)
   {
      MAGMA_png_warning(png_ptr, "Only compression windows >= 256 supported by PNG");
      window_bits = 8;
   }
...
void
MAGMA_png_set_compression_method(png_structrp png_ptr, int method)
{
   ((void)0);
   ...
   if (method != 8)
      MAGMA_png_warning(png_ptr, "Only compression method 8 is supported by PNG");
...
void
MAGMA_png_set_text_compression_level(png_structrp png_ptr, int level)
{
   ((void)0);
...
void
MAGMA_png_set_text_compression_mem_level(png_structrp png_ptr, int mem_level)
{
   ((void)0);
...
void
MAGMA_png_set_text_compression_strategy(png_structrp png_ptr, int strategy)
{
   ((void)0);
...
void
MAGMA_png_set_text_compression_window_bits(png_structrp png_ptr, int window_bits)
{
   if (png_ptr == ((void*)0))
      return;
...
void
MAGMA_png_set_text_compression_method(png_structrp png_ptr, int method)
{
   ((void)0);
...
void
MAGMA_png_set_write_status_fn(png_structrp png_ptr, png_write_status_ptr write_row_fn)
{
   if (png_ptr == ((void*)0))
      return;
...
void
MAGMA_png_set_write_user_transform_fn(png_structrp png_ptr, png_user_transform_ptr
...
void
MAGMA_png_write_png(png_structrp png_ptr, png_inforp info_ptr,
    int transforms, voidp params)
{
   ...
   {
      MAGMA_png_app_error(png_ptr, "no rows for png_write_image to write");
      return;
   }


   MAGMA_png_write_info(png_ptr, info_ptr);
...
# 1394 "/benchmark/project/libpng/repo/pngwrite.c"
       ...
       0x0800)) != 0)
   {
      ...
      if ((transforms & 0x1000) != 0)
      {
         ...
         MAGMA_png_set_filler(png_ptr, 0, 1);
      }

      else if ((transforms & 0x0800) != 0)
         MAGMA_png_set_filler(png_ptr, 0, 0);
   ...
   MAGMA_png_write_image(png_ptr, info_ptr->row_pointers);


   MAGMA_png_write_end(png_ptr, info_ptr);
...
{
   png_structp png_ptr = MAGMA_png_create_write_struct("1.6.38.git", image,
   ...
   if (png_ptr != ((void*)0))
   {
      ...
      MAGMA_png_destroy_write_struct(&png_ptr, ((void*)0));
   }

   return MAGMA_png_image_error(image, "png_image_write_: out of memory");
}
...
png_write_image_16bit(png_voidp argument)
{
   ...
   unsigned int channels = (image->format & 0x02U) != 0 ?
       3 : 1;
   int aindex = 0;
   png_uint_32 y = image->height;

   if ((image->format & 0x01U) != 0)
   {

      if ((image->format & 0x20U) != 0)
      {
         aindex = -1;
         ++input_row;
         ++output_row;
      ...
      MAGMA_png_error(png_ptr, "png_write_image: internal call error");
...
# 1597 "/benchmark/project/libpng/repo/pngwrite.c"
            if (component >= alpha)
               component = 65535;
      ...
      MAGMA_png_write_row(png_ptr, (display->local_row));
      input_row += (png_uint_16)display->row_bytes/(sizeof (png_uint_16));
   }

   return 1;
}
# 1636 "/benchmark/project/libpng/repo/pngwrite.c"
static png_byte
png_unpremultiply(png_uint_32 component, png_uint_32 alpha,
    png_uint_32 reciprocal )
{
# 1650 "/benchmark/project/libpng/repo/pngwrite.c"
   ...
   else if (component > 0)
   {
      ...
      return (png_byte)((png_byte)(0xff & ((MAGMA_png_sRGB_base[(component)>>15] + ((((component) & 0x7fff)*MAGMA_png_sRGB_delta[(component)>>15])>>12)) >> 8)));
   }
   ...
   else
   {
      ...
      for (; y > 0; --y)
      {
         ...
         while (out_ptr < row_end)
         {
            ...
            component *= 255;
            *out_ptr++ = (png_byte)((png_byte)(0xff & ((MAGMA_png_sRGB_base[(component)>>15] + ((((component) & 0x7fff)*MAGMA_png_sRGB_delta[(component)>>15])>>12)) >> 8)));
         }

         MAGMA_png_write_row(png_ptr, output_row);
         input_row += (png_uint_16)display->row_bytes/(sizeof (png_uint_16));
      }
   }
...
png_image_set_PLTE(png_image_write_control *display)
{
   ...
   unsigned int channels = (((format)&(0x02U|0x01U))+1);



      int afirst = (format & 0x20U) != 0 &&
          (format & 0x01U) != 0;
   ...
   for (i=num_trans=0; i<entries; ++i)
   {
      ...
      if ((format & 0x04U) != 0)
      {
         ...
         if ((channels & 1) != 0)
         {
            if (channels >= 3)
            {
               palette[i].blue = (png_byte)((png_byte)(0xff & ((MAGMA_png_sRGB_base[(255 * entry[(2 ^ bgr)])>>15] + ((((255 * entry[(2 ^ bgr)]) & 0x7fff)*MAGMA_png_sRGB_delta[(255 * entry[(2 ^ bgr)])>>15])>>12)) >> 8)));

               palette[i].green = (png_byte)((png_byte)(0xff & ((MAGMA_png_sRGB_base[(255 * entry[1])>>15] + ((((255 * entry[1]) & 0x7fff)*MAGMA_png_sRGB_delta[(255 * entry[1])>>15])>>12)) >> 8)));

               palette[i].red = (png_byte)((png_byte)(0xff & ((MAGMA_png_sRGB_base[(255 * entry[bgr])>>15] + ((((255 * entry[bgr]) & 0x7fff)*MAGMA_png_sRGB_delta[(255 * entry[bgr])>>15])>>12)) >> 8)));

            }

            else
               palette[i].blue = palette[i].red = palette[i].green =
                  (png_byte)((png_byte)(0xff & ((MAGMA_png_sRGB_base[(255 * *entry)>>15] + ((((255 * *entry) & 0x7fff)*MAGMA_png_sRGB_delta[(255 * *entry)>>15])>>12)) >> 8)));
         }
...
# 1914 "/benchmark/project/libpng/repo/pngwrite.c"
   MAGMA_png_set_PLTE(image->opaque->png_ptr, image->opaque->info_ptr, palette,
       entries);

   if (num_trans > 0)
      MAGMA_png_set_tRNS(image->opaque->png_ptr, image->opaque->info_ptr, tRNS,
          num_trans, ((void*)0));
...
png_image_write_main(png_voidp argument)
{
   ...
   int colormap = (format & 0x08U);
   int linear = !colormap && (format & 0x04U);
   int alpha = !colormap && (format & 0x01U);
   int write_16bit = linear && (display->convert_to_8bit == 0);



      MAGMA_png_set_benign_errors(png_ptr, 0 );
      ...
      if (image->width <= 0x7fffffffU/channels)
      {
         ...
         if (check >= png_row_stride)
         {
            ...
            if (image->height > 0xffffffffU/png_row_stride)
               MAGMA_png_error(image->opaque->png_ptr, "memory image too large");
         }

         else
            MAGMA_png_error(image->opaque->png_ptr, "supplied row stride too small");
      }

      else
         MAGMA_png_error(image->opaque->png_ptr, "image row stride too large");
   }
   ...
   if ((format & 0x08U) != 0)
   {
      if (display->colormap != ((void*)0) && image->colormap_entries > 0)
      {
         ...
         MAGMA_png_set_IHDR(png_ptr, info_ptr, image->width, image->height,
         ...
         MAGMA_png_error(image->opaque->png_ptr,
   ...
   if (write_16bit != 0)
   {
      ...
      MAGMA_png_set_gAMA_fixed(png_ptr, info_ptr, 100000);

      if ((image->flags & 0x01) == 0)
         MAGMA_png_set_cHRM_fixed(png_ptr, info_ptr,
   ...
   else if ((image->flags & 0x01) == 0)
      MAGMA_png_set_sRGB(png_ptr, info_ptr, 0);




   else
      MAGMA_png_set_gAMA_fixed(png_ptr, info_ptr, 45455);
   ...
   if ((format & ~(png_uint_32)(0x02U | 0x04U |
         0x01U | 0x08U)) != 0)
      MAGMA_png_error(png_ptr, "png_write_image: unsupported transformation");
   ...
   {
      MAGMA_png_set_filter(png_ptr, 0, 0x00);
      ...
      MAGMA_png_set_compression_level(png_ptr, 3);
   ...
   {
      png_bytep row = (MAGMA_png_malloc(png_ptr, MAGMA_png_get_rowbytes(png_ptr, info_ptr)));

      int result;

      display->local_row = row;
      if (write_16bit != 0)
         result = MAGMA_png_safe_execute(image, png_write_image_16bit, display);
      else
         result = MAGMA_png_safe_execute(image, png_write_image_8bit, display);
   ...
   else
   {
      ...
      for (; y > 0; --y)
      {
         MAGMA_png_write_row(png_ptr, row);
         row += row_bytes;
      }
   }
...
{
   png_image_write_control *display = (png_ptr->io_ptr);
   ...
   if (size <= ((png_alloc_size_t)-1) - ob)
   {
      ...
      MAGMA_png_error(png_ptr, "png_image_write_to_memory: PNG too big");
}
...
png_image_write_memory(png_voidp argument)
{
   ...
   MAGMA_png_set_write_fn(display->image->opaque->png_ptr, display ,
...
int
MAGMA_png_image_write_to_memory(png_imagep image, void *memory,
    png_alloc_size_t * __restrict memory_bytes, int convert_to_8bit,
    const void *buffer, png_int_32 row_stride, const void *colormap)
{

   if (image != ((void*)0) && image->version == 1)
   {
      if (memory_bytes != ((void*)0) && buffer != ((void*)0))
      {
         ...
         if (png_image_write_init(image) != 0)
         {
            ...
            result = MAGMA_png_safe_execute(image, png_image_write_memory, &display);
            ...
            if (result)
            {
               ...
               if (memory != ((void*)0) && display.output_bytes > *memory_bytes)
                  result = 0;
...
int
MAGMA_png_image_write_to_stdio(png_imagep image, FILE *file, int convert_to_8bit,
    const void *buffer, png_int_32 row_stride, const void *colormap)
{

   if (image != ((void*)0) && image->version == 1)
   {
      if (file != ((void*)0) && buffer != ((void*)0))
      {
         if (png_image_write_init(image) != 0)
         {
            png_image_write_control display;
            ...
            result = MAGMA_png_safe_execute(image, png_image_write_main, &display);
            MAGMA_png_image_free(image);
            return result;
         }
...
int
MAGMA_png_image_write_to_file(png_imagep image, const char *file_name,
    ...
    const void *colormap)
{
   ...
   if (image != ((void*)0) && image->version == 1)
   {
      if (file_name != ((void*)0) && buffer != ((void*)0))
      {
         FILE *fp = fopen(file_name, "wb");

         if (fp != ((void*)0))
         {
            if (MAGMA_png_image_write_to_stdio(image, fp, convert_to_8bit, buffer,
                row_stride, colormap) != 0)
            {
               ...
               return MAGMA_png_image_error(image, strerror(error));
            }
