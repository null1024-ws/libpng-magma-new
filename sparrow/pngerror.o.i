# 1 "/benchmark/project/libpng/repo/pngerror.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngerror.c" 2
# 19 "/benchmark/project/libpng/repo/pngerror.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 20 "/benchmark/project/libpng/repo/pngerror.c" 2
...
# 38 "/benchmark/project/libpng/repo/pngerror.c"
__attribute__((__noreturn__)) void MAGMA_png_error (png_const_structrp png_ptr, png_const_charp error_message)


{
# 82 "/benchmark/project/libpng/repo/pngerror.c"
   if (png_ptr != ((void*)0) && png_ptr->error_fn != ((void*)0))
      (*(png_ptr->error_fn))(((png_structrp)(png_ptruint)(const void*)(png_ptr)),
          error_message);
...
# 111 "/benchmark/project/libpng/repo/pngerror.c"
size_t
MAGMA_png_safecat(png_charp buffer, size_t bufsize, size_t pos,
...
png_charp
MAGMA_png_format_number(png_const_charp start, png_charp end, int format,
...
# 215 "/benchmark/project/libpng/repo/pngerror.c"
void
MAGMA_png_warning(png_const_structrp png_ptr, png_const_charp warning_message)
{
   int offset = 0;
   if (png_ptr != ((void*)0))
   {
   ...
   if (png_ptr != ((void*)0) && png_ptr->warning_fn != ((void*)0))
      (*(png_ptr->warning_fn))(((png_structrp)(png_ptruint)(const void*)(png_ptr)),
...
void
MAGMA_png_warning_parameter(png_warning_parameters p, int number,
    png_const_charp string)
{
   if (number > 0 && number <= 8)
      (void)MAGMA_png_safecat(p[number-1], (sizeof p[number-1]), 0, string);
}

void
MAGMA_png_warning_parameter_unsigned(png_warning_parameters p, int number, int format,
    png_alloc_size_t value)
{
   char buffer[24];
   MAGMA_png_warning_parameter(p, number, MAGMA_png_format_number(buffer, buffer + (sizeof buffer), format, value));
}

void
MAGMA_png_warning_parameter_signed(png_warning_parameters p, int number, int format,
    png_int_32 value)
{
   png_alloc_size_t u;
   png_charp str;
   ...
   str = MAGMA_png_format_number(buffer, buffer + (sizeof buffer), format, u);

   if (value < 0 && str > buffer)
      *--str = '-';

   MAGMA_png_warning_parameter(p, number, str);
}

void
MAGMA_png_formatted_warning(png_const_structrp png_ptr, png_warning_parameters p,
    png_const_charp message)
{
   ...
   MAGMA_png_warning(png_ptr, msg);
}



void
MAGMA_png_benign_error(png_const_structrp png_ptr, png_const_charp error_message)
{
   if ((png_ptr->flags & 0x100000U) != 0)
   {
         ...
         if ((png_ptr->mode & 0x8000U) != 0 &&
            ...
            MAGMA_png_chunk_warning(png_ptr, error_message);
         else

      MAGMA_png_warning(png_ptr, error_message);
   }
   ...
   else
   {
         ...
         if ((png_ptr->mode & 0x8000U) != 0 &&
            png_ptr->chunk_name != 0)
            MAGMA_png_chunk_error(png_ptr, error_message);
         else

      MAGMA_png_error(png_ptr, error_message);
   }
...
void
MAGMA_png_app_warning(png_const_structrp png_ptr, png_const_charp error_message)
{
...
void
MAGMA_png_app_error(png_const_structrp png_ptr, png_const_charp error_message)
{
...
# 428 "/benchmark/project/libpng/repo/pngerror.c"
...
__attribute__((__noreturn__)) void MAGMA_png_chunk_error (png_const_structrp png_ptr, png_const_charp error_message)
...
void
MAGMA_png_chunk_warning(png_const_structrp png_ptr, png_const_charp warning_message)
{
   char msg[18+196];
   if (png_ptr == ((void*)0))
      MAGMA_png_warning(png_ptr, warning_message);
...
void
MAGMA_png_chunk_benign_error(png_const_structrp png_ptr, png_const_charp
    error_message)
{
   if ((png_ptr->flags & 0x100000U) != 0)
      MAGMA_png_chunk_warning(png_ptr, error_message);
...
void
MAGMA_png_chunk_report(png_const_structrp png_ptr, png_const_charp message, int error)
{
# 541 "/benchmark/project/libpng/repo/pngerror.c"
      if ((png_ptr->mode & 0x8000U) != 0)
      ...
      {
         if (error < 2)
            MAGMA_png_chunk_warning(png_ptr, message);

         else
            MAGMA_png_chunk_benign_error(png_ptr, message);
      }
      ...
      {
         if (error < 1)
            MAGMA_png_app_warning(png_ptr, message);

         else
            MAGMA_png_app_error(png_ptr, message);
      }
...
__attribute__((__noreturn__)) void MAGMA_png_fixed_error (png_const_structrp png_ptr, png_const_charp name)
...
jmp_buf*
MAGMA_png_set_longjmp_fn(png_structrp png_ptr, png_longjmp_ptr longjmp_fn,
    size_t jmp_buf_size)
{
# 610 "/benchmark/project/libpng/repo/pngerror.c"
   if (png_ptr == ((void*)0))
      return ((void*)0);
   ...
   if (png_ptr->jmp_buf_ptr == ((void*)0))
   {
      ...
      {
         png_ptr->jmp_buf_ptr = (MAGMA_png_malloc_warn(png_ptr, jmp_buf_size));
   ...
   else
   {
      ...
      if (size == 0)
      {
         ...
         if (png_ptr->jmp_buf_ptr != &png_ptr->jmp_buf_local)
         {
            ...
            MAGMA_png_error(png_ptr, "Libpng jmp_buf still allocated");
      ...
      {
         MAGMA_png_warning(png_ptr, "Application jmp_buf size changed");
         return ((void*)0);
      }
   }
...
void
MAGMA_png_free_jmpbuf(png_structrp png_ptr)
{
   if (png_ptr != ((void*)0))
   {
...
{
# 746 "/benchmark/project/libpng/repo/pngerror.c"
   {
   ...
   MAGMA_png_longjmp(png_ptr, 1);
}

__attribute__((__noreturn__)) void MAGMA_png_longjmp (png_const_structrp png_ptr, int val)

{

   if (png_ptr != ((void*)0) && png_ptr->longjmp_fn != ((void*)0) &&
       png_ptr->jmp_buf_ptr != ((void*)0))
      png_ptr->longjmp_fn(*png_ptr->jmp_buf_ptr, val);
# 775 "/benchmark/project/libpng/repo/pngerror.c"
   abort();
}
...
png_default_warning(png_const_structrp png_ptr, png_const_charp warning_message)
{
# 818 "/benchmark/project/libpng/repo/pngerror.c"
   {
...
void
MAGMA_png_set_error_fn(png_structrp png_ptr, png_voidp error_ptr,
...
png_voidp
MAGMA_png_get_error_ptr(png_const_structrp png_ptr)
{
   if (png_ptr == ((void*)0))
      return ((void*)0);
...
# 884 "/benchmark/project/libpng/repo/pngerror.c"
__attribute__((__noreturn__)) void (MAGMA_png_safe_error) (png_structp png_nonconst_ptr, png_const_charp error_message)
...

{
   ...
   if (image != ((void*)0))
   {
      ...
      {
         size_t pos = MAGMA_png_safecat(image->message, (sizeof image->message), 0,
             "bad longjmp: ");
         MAGMA_png_safecat(image->message, (sizeof image->message), pos,
             error_message);
      }
   }
...
void
MAGMA_png_safe_warning(png_structp png_nonconst_ptr, png_const_charp warning_message)
{
   png_const_structrp png_ptr = png_nonconst_ptr;
   png_imagep image = (png_ptr->error_ptr);
   ...
   {
      MAGMA_png_safecat(image->message, (sizeof image->message), 0, warning_message);
...
int
MAGMA_png_safe_execute(png_imagep image_in, int (*function)(png_voidp), png_voidp arg)
{
