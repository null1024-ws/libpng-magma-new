# 1 "/benchmark/project/libpng/repo/pngset.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngset.c" 2
# 19 "/benchmark/project/libpng/repo/pngset.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 20 "/benchmark/project/libpng/repo/pngset.c" 2




void
MAGMA_png_set_bKGD(png_const_structrp png_ptr, png_inforp info_ptr,
...
void
MAGMA_png_set_cHRM_fixed(png_const_structrp png_ptr, png_inforp info_ptr,
    ...
    png_fixed_point blue_x, png_fixed_point blue_y)
{
   ...
   if (MAGMA_png_colorspace_set_chromaticities(png_ptr, &info_ptr->colorspace, &xy,
       2 ) != 0)
...
void
MAGMA_png_set_cHRM_XYZ_fixed(png_const_structrp png_ptr, png_inforp info_ptr,
    ...
    png_fixed_point int_blue_Z)
{
   ...
   if (MAGMA_png_colorspace_set_endpoints(png_ptr, &info_ptr->colorspace,
       &XYZ, 2) != 0)
      info_ptr->colorspace.flags |= 0x0010;
...
void
MAGMA_png_set_cHRM(png_const_structrp png_ptr, png_inforp info_ptr,
    double white_x, double white_y, double red_x, double red_y,
    double green_x, double green_y, double blue_x, double blue_y)
{
   MAGMA_png_set_cHRM_fixed(png_ptr, info_ptr,
       MAGMA_png_fixed(png_ptr, white_x, "cHRM White X"),
       MAGMA_png_fixed(png_ptr, white_y, "cHRM White Y"),
       MAGMA_png_fixed(png_ptr, red_x, "cHRM Red X"),
       MAGMA_png_fixed(png_ptr, red_y, "cHRM Red Y"),
       MAGMA_png_fixed(png_ptr, green_x, "cHRM Green X"),
       MAGMA_png_fixed(png_ptr, green_y, "cHRM Green Y"),
       MAGMA_png_fixed(png_ptr, blue_x, "cHRM Blue X"),
       MAGMA_png_fixed(png_ptr, blue_y, "cHRM Blue Y"));
}

void
MAGMA_png_set_cHRM_XYZ(png_const_structrp png_ptr, png_inforp info_ptr, double red_X,
    double red_Y, double red_Z, double green_X, double green_Y, double green_Z,
    double blue_X, double blue_Y, double blue_Z)
{
   MAGMA_png_set_cHRM_XYZ_fixed(png_ptr, info_ptr,
       MAGMA_png_fixed(png_ptr, red_X, "cHRM Red X"),
       MAGMA_png_fixed(png_ptr, red_Y, "cHRM Red Y"),
       MAGMA_png_fixed(png_ptr, red_Z, "cHRM Red Z"),
       MAGMA_png_fixed(png_ptr, green_X, "cHRM Green X"),
       MAGMA_png_fixed(png_ptr, green_Y, "cHRM Green Y"),
       MAGMA_png_fixed(png_ptr, green_Z, "cHRM Green Z"),
       MAGMA_png_fixed(png_ptr, blue_X, "cHRM Blue X"),
       MAGMA_png_fixed(png_ptr, blue_Y, "cHRM Blue Y"),
       MAGMA_png_fixed(png_ptr, blue_Z, "cHRM Blue Z"));
}
...
void
MAGMA_png_set_eXIf(png_const_structrp png_ptr, png_inforp info_ptr,
    png_bytep eXIf_buf)
{
  MAGMA_png_warning(png_ptr, "png_set_eXIf does not work; use png_set_eXIf_1");
  (void)info_ptr;
  (void)eXIf_buf;
}

void
MAGMA_png_set_eXIf_1(png_const_structrp png_ptr, png_inforp info_ptr,
    png_uint_32 num_exif, png_bytep eXIf_buf)
{
   ...
   info_ptr->exif = (MAGMA_png_malloc_warn(png_ptr, info_ptr->num_exif));


   if (info_ptr->exif == ((void*)0))
   {
      MAGMA_png_warning(png_ptr, "Insufficient memory for eXIf chunk data");
      return;
   }
...
void
MAGMA_png_set_gAMA_fixed(png_const_structrp png_ptr, png_inforp info_ptr,
    png_fixed_point file_gamma)
{
   ...
   MAGMA_png_colorspace_set_gamma(png_ptr, &info_ptr->colorspace, file_gamma);
   MAGMA_png_colorspace_sync_info(png_ptr, info_ptr);
}


void
MAGMA_png_set_gAMA(png_const_structrp png_ptr, png_inforp info_ptr, double file_gamma)
{
   MAGMA_png_set_gAMA_fixed(png_ptr, info_ptr, MAGMA_png_fixed(png_ptr, file_gamma,
       "png_set_gAMA"));
}
...
void
MAGMA_png_set_hIST(png_const_structrp png_ptr, png_inforp info_ptr,
    png_const_uint_16p hist)
{
   ...
   MAGMA_png_free_data(png_ptr, info_ptr, 0x0008U, 0);




   info_ptr->hist = (MAGMA_png_malloc_warn(png_ptr, 256 * (sizeof (png_uint_16))));


   if (info_ptr->hist == ((void*)0))
   {
      MAGMA_png_warning(png_ptr, "Insufficient memory for hIST chunk data");
...
void
MAGMA_png_set_IHDR(png_const_structrp png_ptr, png_inforp info_ptr,
...
void
MAGMA_png_set_oFFs(png_const_structrp png_ptr, png_inforp info_ptr,
...
void
MAGMA_png_set_pCAL(png_const_structrp png_ptr, png_inforp info_ptr,
    ...
    int nparams, png_const_charp units, png_charpp params)
{
   ...
   if (type < 0 || type > 3)
   {
      MAGMA_png_chunk_report(png_ptr, "Invalid pCAL equation type",
            1);
      return;
   }
   ...
   {
      MAGMA_png_chunk_report(png_ptr, "Invalid pCAL parameter count",
            1);
      return;
   }
   ...
   {
      if (params[i] == ((void*)0) ||
          !MAGMA_png_check_fp_string(params[i], strlen(params[i])))
      {
         MAGMA_png_chunk_report(png_ptr, "Invalid format for pCAL parameter",
               1);
         return;
      }
   }

   info_ptr->pcal_purpose = (MAGMA_png_malloc_warn(png_ptr, length));


   if (info_ptr->pcal_purpose == ((void*)0))
   {
      MAGMA_png_chunk_report(png_ptr, "Insufficient memory for pCAL purpose",
            1);
      return;
   }
   ...
   info_ptr->pcal_units = (MAGMA_png_malloc_warn(png_ptr, length));


   if (info_ptr->pcal_units == ((void*)0))
   {
      MAGMA_png_warning(png_ptr, "Insufficient memory for pCAL units");
   ...
   info_ptr->pcal_params = (MAGMA_png_malloc_warn(png_ptr, (size_t)(((unsigned int)nparams + 1) * (sizeof (png_charp)))));


   if (info_ptr->pcal_params == ((void*)0))
   {
      MAGMA_png_warning(png_ptr, "Insufficient memory for pCAL params");
   ...
   for (i = 0; i < nparams; i++)
   {
      ...
      info_ptr->pcal_params[i] = (png_charp)MAGMA_png_malloc_warn(png_ptr, length);

      if (info_ptr->pcal_params[i] == ((void*)0))
      {
         MAGMA_png_warning(png_ptr, "Insufficient memory for pCAL parameter");
...
void
MAGMA_png_set_sCAL_s(png_const_structrp png_ptr, png_inforp info_ptr,
    int unit, png_const_charp swidth, png_const_charp sheight)
{
   ...
   if (unit != 1 && unit != 2)
      MAGMA_png_error(png_ptr, "Invalid sCAL unit");

   if (swidth == ((void*)0) || (lengthw = strlen(swidth)) == 0 ||
       swidth[0] == 45 || !MAGMA_png_check_fp_string(swidth, lengthw))
      MAGMA_png_error(png_ptr, "Invalid sCAL width");

   if (sheight == ((void*)0) || (lengthh = strlen(sheight)) == 0 ||
       sheight[0] == 45 || !MAGMA_png_check_fp_string(sheight, lengthh))
      MAGMA_png_error(png_ptr, "Invalid sCAL height");
   ...
   info_ptr->scal_s_width = (MAGMA_png_malloc_warn(png_ptr, lengthw));


   if (info_ptr->scal_s_width == ((void*)0))
   {
      MAGMA_png_warning(png_ptr, "Memory allocation failed while processing sCAL");
   ...
   info_ptr->scal_s_height = (MAGMA_png_malloc_warn(png_ptr, lengthh));
...
void
MAGMA_png_set_sCAL(png_const_structrp png_ptr, png_inforp info_ptr, int unit,
    double width, double height)
{
   ...
   if (width <= 0)
      MAGMA_png_warning(png_ptr, "Invalid sCAL width ignored");

   else if (height <= 0)
      MAGMA_png_warning(png_ptr, "Invalid sCAL height ignored");
   ...
   else
   {
      ...
      MAGMA_png_ascii_from_fp(png_ptr, swidth, (sizeof swidth), width,
          5);
      MAGMA_png_ascii_from_fp(png_ptr, sheight, (sizeof sheight), height,
          5);

      MAGMA_png_set_sCAL_s(png_ptr, info_ptr, unit, swidth, sheight);
   }
}
...
void
MAGMA_png_set_sCAL_fixed(png_const_structrp png_ptr, png_inforp info_ptr, int unit,
    png_fixed_point width, png_fixed_point height)
{
   ...
   else
   {
      ...
      MAGMA_png_ascii_from_fixed(png_ptr, swidth, (sizeof swidth), width);
      MAGMA_png_ascii_from_fixed(png_ptr, sheight, (sizeof sheight), height);
...
void
MAGMA_png_set_pHYs(png_const_structrp png_ptr, png_inforp info_ptr,
...
void
MAGMA_png_set_PLTE(png_structrp png_ptr, png_inforp info_ptr,
    png_const_colorp palette, int num_palette)
{
   ...
   max_palette_length = (info_ptr->color_type == (2 | 1)) ?
   ...
   if (num_palette < 0 || num_palette > (int) max_palette_length)
   {
      ...
      {
         MAGMA_png_warning(png_ptr, "Invalid palette length");
...
# 616 "/benchmark/project/libpng/repo/pngset.c"
   ...
   png_ptr->palette = (MAGMA_png_calloc(png_ptr, 256 * (sizeof (png_color))));
...
void
MAGMA_png_set_sBIT(png_const_structrp png_ptr, png_inforp info_ptr,
...
void
MAGMA_png_set_sRGB(png_const_structrp png_ptr, png_inforp info_ptr, int srgb_intent)
{
   ((void)0);
   ...
   (void)MAGMA_png_colorspace_set_sRGB(png_ptr, &info_ptr->colorspace, srgb_intent);
   MAGMA_png_colorspace_sync_info(png_ptr, info_ptr);
}

void
MAGMA_png_set_sRGB_gAMA_and_cHRM(png_const_structrp png_ptr, png_inforp info_ptr,
    int srgb_intent)
{
   ((void)0);
   ...
   if (MAGMA_png_colorspace_set_sRGB(png_ptr, &info_ptr->colorspace,
       srgb_intent) != 0)
   {
...
void
MAGMA_png_set_iCCP(png_const_structrp png_ptr, png_inforp info_ptr,
    ...
    png_const_bytep profile, png_uint_32 proflen)
{
   ...
   if (compression_type != 0)
      MAGMA_png_app_error(png_ptr, "Invalid iCCP compression method");
   ...
   {
      int result = MAGMA_png_colorspace_set_ICC(png_ptr, &info_ptr->colorspace, name,
   ...
   new_iccp_name = (MAGMA_png_malloc_warn(png_ptr, length));

   if (new_iccp_name == ((void*)0))
   {
      MAGMA_png_benign_error(png_ptr, "Insufficient memory to process iCCP chunk");

      return;
   }

   memcpy(new_iccp_name, name, length);
   new_iccp_profile = (MAGMA_png_malloc_warn(png_ptr, proflen));


   if (new_iccp_profile == ((void*)0))
   {
      MAGMA_png_free(png_ptr, new_iccp_name);
      MAGMA_png_benign_error(png_ptr,
   ...
   MAGMA_png_free_data(png_ptr, info_ptr, 0x0010U, 0);
...
void
MAGMA_png_set_text(png_const_structrp png_ptr, png_inforp info_ptr,
    png_const_textp text_ptr, int num_text)
{
   int ret;
   ret = MAGMA_png_set_text_2(png_ptr, info_ptr, text_ptr, num_text);

   if (ret != 0)
      MAGMA_png_error(png_ptr, "Insufficient memory to store text");
}

int
MAGMA_png_set_text_2(png_const_structrp png_ptr, png_inforp info_ptr,
    png_const_textp text_ptr, int num_text)
{
   int i;
   ...
   if (num_text > info_ptr->max_text - info_ptr->num_text)
   {
      ...
      if (num_text <= 2147483647 - max_text)
      {
         ...
         new_text = (MAGMA_png_realloc_array(png_ptr, info_ptr->text, old_num_text, max_text-old_num_text, sizeof *new_text));
      ...
      if (new_text == ((void*)0))
      {
         MAGMA_png_chunk_report(png_ptr, "too many text chunks",
             1);
   ...
   for (i = 0; i < num_text; i++)
   {
      ...
      {
         MAGMA_png_chunk_report(png_ptr, "text compression mode is out of range",
             1);
         continue;
      }
...
# 884 "/benchmark/project/libpng/repo/pngset.c"
      ...
      textp->key = (MAGMA_png_malloc_base(png_ptr, key_len + text_length + lang_len + lang_key_len + 4));


      if (textp->key == ((void*)0))
      {
         MAGMA_png_chunk_report(png_ptr, "text chunk: out of memory",
             1);
...
void
MAGMA_png_set_tIME(png_const_structrp png_ptr, png_inforp info_ptr,
...
void
MAGMA_png_set_tRNS(png_structrp png_ptr, png_inforp info_ptr,
    png_const_bytep trans_alpha, int num_trans, png_const_color_16p trans_color)
{
   ...
   {
# 1014 "/benchmark/project/libpng/repo/pngset.c"
       MAGMA_png_free_data(png_ptr, info_ptr, 0x2000U, 0);

       if (num_trans > 0 && num_trans <= 256)
       {

          info_ptr->trans_alpha = (MAGMA_png_malloc(png_ptr, 256));
...
void
MAGMA_png_set_sPLT(png_const_structrp png_ptr,
    png_inforp info_ptr, png_const_sPLT_tp entries, int nentries)
# 1072 "/benchmark/project/libpng/repo/pngset.c"
{
   png_sPLT_tp np;
   ...
   np = (MAGMA_png_realloc_array(png_ptr, info_ptr->splt_palettes, info_ptr->splt_palettes_num, nentries, sizeof *np));
   ...
   if (np == ((void*)0))
   {
      ...
      MAGMA_png_chunk_report(png_ptr, "too many sPLT chunks", 1);
   ...
   do
   {
      ...
      if (entries->name == ((void*)0) || entries->entries == ((void*)0))
      {
         ...
         MAGMA_png_app_error(png_ptr, "png_set_sPLT: invalid sPLT");
      ...
      np->name = (MAGMA_png_malloc_base(png_ptr, length));
      ...
      np->entries = (MAGMA_png_malloc_array(png_ptr, entries->nentries, sizeof (png_sPLT_entry)));


      if (np->entries == ((void*)0))
      {
         MAGMA_png_free(png_ptr, np->name);
         np->name = ((void*)0);
         break;
      }
   ...
   if (nentries > 0)
      MAGMA_png_chunk_report(png_ptr, "sPLT out of memory", 1);
}
...
check_location(png_const_structrp png_ptr, int location)
{
   ...
   if (location == 0)
      MAGMA_png_error(png_ptr, "invalid location in png_set_unknown_chunks");
...
void
MAGMA_png_set_unknown_chunks(png_const_structrp png_ptr,
    png_inforp info_ptr, png_const_unknown_chunkp unknowns, int num_unknowns)
{
   ...
   if (png_ptr == ((void*)0) || info_ptr == ((void*)0) || num_unknowns <= 0 ||
       unknowns == ((void*)0))
      return;
# 1239 "/benchmark/project/libpng/repo/pngset.c"
   np = (MAGMA_png_realloc_array(png_ptr, info_ptr->unknown_chunks, info_ptr->unknown_chunks_num, num_unknowns, sizeof *np));



   if (np == ((void*)0))
   {
      MAGMA_png_chunk_report(png_ptr, "too many unknown chunks",
          1);
   ...
   for (; num_unknowns > 0; --num_unknowns, ++unknowns)
   {
      ...
      {
         np->data = (MAGMA_png_malloc_base(png_ptr, unknowns->size));


         if (np->data == ((void*)0))
         {
            MAGMA_png_chunk_report(png_ptr, "unknown chunk: out of memory",
                1);
...
void
MAGMA_png_set_unknown_chunk_location(png_const_structrp png_ptr, png_inforp info_ptr,
    int chunk, int location)
{
      ...
      chunk < info_ptr->unknown_chunks_num)
   {
      ...
      {
         MAGMA_png_app_error(png_ptr, "invalid unknown chunk location");
...
png_uint_32
MAGMA_png_permit_mng_features(png_structrp png_ptr, png_uint_32 mng_features)
{
   ((void)0);
...
void
MAGMA_png_set_keep_unknown_chunks(png_structrp png_ptr, int keep,
    png_const_bytep chunk_list, int num_chunks_in)
{
   ...
   if (keep < 0 || keep >= 4)
   {
      MAGMA_png_app_error(png_ptr, "png_set_keep_unknown_chunks: invalid keep");
   ...
   else
   {
      if (chunk_list == ((void*)0))
      {
         ...
         MAGMA_png_app_error(png_ptr, "png_set_keep_unknown_chunks: no chunk list");
   ...
   {
      MAGMA_png_app_error(png_ptr, "png_set_keep_unknown_chunks: too many chunks");
   ...
   if (keep != 0)
   {
      new_list = (MAGMA_png_malloc(png_ptr, 5 * (num_chunks + old_num_chunks)));
   ...
   if (new_list != ((void*)0))
   {
      ...
      if (num_chunks == 0)
      {
         if (png_ptr->chunk_list != new_list)
            MAGMA_png_free(png_ptr, new_list);
...
void
MAGMA_png_set_read_user_chunk_fn(png_structrp png_ptr, png_voidp user_chunk_ptr,
    png_user_chunk_ptr read_user_chunk_fn)
{
   ((void)0);
...
void
MAGMA_png_set_rows(png_const_structrp png_ptr, png_inforp info_ptr,
    png_bytepp row_pointers)
{
   ((void)0);
...
void
MAGMA_png_set_compression_buffer_size(png_structrp png_ptr, size_t size)
{
   if (png_ptr == ((void*)0))
      return;

   if (size == 0 || size > ((png_uint_32)0x7fffffffL))
      MAGMA_png_error(png_ptr, "invalid compression buffer size");
...
void
MAGMA_png_set_invalid(png_const_structrp png_ptr, png_inforp info_ptr, int mask)
{
   if (png_ptr != ((void*)0) && info_ptr != ((void*)0))
...
void
MAGMA_png_set_user_limits(png_structrp png_ptr, png_uint_32 user_width_max,
    png_uint_32 user_height_max)
{
...
void
MAGMA_png_set_chunk_cache_max(png_structrp png_ptr, png_uint_32 user_chunk_cache_max)
{
   if (png_ptr != ((void*)0))
...
void
MAGMA_png_set_chunk_malloc_max(png_structrp png_ptr,
    png_alloc_size_t user_chunk_malloc_max)
{
   if (png_ptr != ((void*)0))
...
void
MAGMA_png_set_benign_errors(png_structrp png_ptr, int allowed)
{
   ((void)0);
...
# 1700 "/benchmark/project/libpng/repo/pngset.c"
void
MAGMA_png_set_check_for_invalid_index(png_structrp png_ptr, int allowed)
{
   ((void)0);
...
# 1725 "/benchmark/project/libpng/repo/pngset.c"
png_uint_32
MAGMA_png_check_keyword(png_structrp png_ptr, png_const_charp key, png_bytep new_key)
{
   ...
   *new_key = 0;
   ...
   if (*key != 0)
      MAGMA_png_warning(png_ptr, "keyword truncated");

   else if (bad_character != 0)
   {
      png_warning_parameters p;

      MAGMA_png_warning_parameter(p, 1, orig_key);
      MAGMA_png_warning_parameter_signed(p, 2, 4, bad_character);

      MAGMA_png_formatted_warning(png_ptr, p, "keyword \"@1\": bad character '0x@2'");
   }
