# 1 "/benchmark/project/libpng/repo/pngmem.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngmem.c" 2
# 20 "/benchmark/project/libpng/repo/pngmem.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 21 "/benchmark/project/libpng/repo/pngmem.c" 2



void
MAGMA_png_destroy_png_struct(png_structrp png_ptr)
{
   if (png_ptr != ((void*)0))
   {
      ...
      MAGMA_png_free(&dummy_struct, png_ptr);



         MAGMA_png_free_jmpbuf(&dummy_struct);
...
__attribute__((__malloc__)) png_voidp MAGMA_png_calloc (png_const_structrp png_ptr, png_alloc_size_t size)

{
   png_voidp ret;

   ret = MAGMA_png_malloc(png_ptr, size);
...
__attribute__((__malloc__)) png_voidp MAGMA_png_malloc_base (png_const_structrp png_ptr, png_alloc_size_t size)


{
# 83 "/benchmark/project/libpng/repo/pngmem.c"
      ...
      )
   {
      ...
      if (png_ptr != ((void*)0) && png_ptr->malloc_fn != ((void*)0))
         return png_ptr->malloc_fn(((png_structrp)(png_ptruint)(const void*)(png_ptr)), size);
    ...
    size_t element_size)
{
   ...
   if (req <= ((size_t)(-1))/element_size)
      return MAGMA_png_malloc_base(png_ptr, req * element_size);


   return ((void*)0);
}

__attribute__((__malloc__)) png_voidp MAGMA_png_malloc_array (png_const_structrp png_ptr, int nelements, size_t element_size)


{
   if (nelements <= 0 || element_size == 0)
      MAGMA_png_error(png_ptr, "internal error: array alloc");

   return png_malloc_array_checked(png_ptr, nelements, element_size);
}

__attribute__((__malloc__)) png_voidp MAGMA_png_realloc_array (png_const_structrp png_ptr, png_const_voidp old_array, int old_elements, int add_elements, size_t element_size)
...

{
   ...
   if (add_elements <= 0 || element_size == 0 || old_elements < 0 ||
      ...
      MAGMA_png_error(png_ptr, "internal error: array realloc");
...
__attribute__((__malloc__)) png_voidp MAGMA_png_malloc (png_const_structrp png_ptr, png_alloc_size_t size)

{
   ...
   ret = MAGMA_png_malloc_base(png_ptr, size);

   if (ret == ((void*)0))
       MAGMA_png_error(png_ptr, "Out of memory");

   return ret;
}


__attribute__((__malloc__)) png_voidp MAGMA_png_malloc_default (png_const_structrp png_ptr, png_alloc_size_t size)
...

{
   ...
   ret = MAGMA_png_malloc_base(((void*)0) , size);
...
__attribute__((__malloc__)) png_voidp MAGMA_png_malloc_warn (png_const_structrp png_ptr, png_alloc_size_t size)


{
   if (png_ptr != ((void*)0))
   {
      png_voidp ret = MAGMA_png_malloc_base(png_ptr, size);

      if (ret != ((void*)0))
         return ret;

      MAGMA_png_warning(png_ptr, "Out of memory");
   }
...
void
MAGMA_png_free(png_const_structrp png_ptr, png_voidp ptr)
{
   ...
   if (png_ptr->free_fn != ((void*)0))
      png_ptr->free_fn(((png_structrp)(png_ptruint)(const void*)(png_ptr)), ptr);

   else
      MAGMA_png_free_default(png_ptr, ptr);
}

void MAGMA_png_free_default (png_const_structrp png_ptr, png_voidp ptr)
...
void
MAGMA_png_set_mem_fn(png_structrp png_ptr, png_voidp mem_ptr, png_malloc_ptr
...
png_voidp
MAGMA_png_get_mem_ptr(png_const_structrp png_ptr)
{
   if (png_ptr == ((void*)0))
      return ((void*)0);
