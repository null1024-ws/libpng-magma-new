# 1 "/benchmark/project/libpng/repo/png.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/png.c" 2
# 14 "/benchmark/project/libpng/repo/png.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 15 "/benchmark/project/libpng/repo/png.c" 2


typedef png_libpng_version_1_6_38_git Your_png_h_is_not_version_1_6_38_git;
# 46 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_set_sig_bytes(png_structrp png_ptr, int num_bytes)
{
   ...
   if (nb > 8)
      MAGMA_png_error(png_ptr, "Too many bytes for PNG signature");

   png_ptr->sig_bytes = (png_byte)nb;
}
# 73 "/benchmark/project/libpng/repo/png.c"
int
MAGMA_png_sig_cmp(png_const_bytep sig, size_t start, size_t num_to_check)
{
...
__attribute__((__malloc__)) voidpf MAGMA_png_zalloc (voidpf png_ptr, uInt items, uInt size)
...
void
MAGMA_png_zfree(voidpf png_ptr, voidpf ptr)
{
   MAGMA_png_free((png_ptr), ptr);
}
...
void
MAGMA_png_reset_crc(png_structrp png_ptr)
{
...
void
MAGMA_png_calculate_crc(png_structrp png_ptr, png_const_bytep ptr, size_t length)
{
   int need_crc = 1;
...
int
MAGMA_png_user_version_check(png_structrp png_ptr, png_const_charp user_png_ver)
{
   ...
   if (user_png_ver != ((void*)0))
   {
      ...
      {
         i++;
         if (user_png_ver[i] != "1.6.38.git"[i])
   ...
   if ((png_ptr->flags & 0x20000U) != 0)
   {
      ...
      pos = MAGMA_png_safecat(m, (sizeof m), pos,
          "Application built with libpng-");
      pos = MAGMA_png_safecat(m, (sizeof m), pos, user_png_ver);
      pos = MAGMA_png_safecat(m, (sizeof m), pos, " but running with ");
      pos = MAGMA_png_safecat(m, (sizeof m), pos, "1.6.38.git");
      (void)pos;

      MAGMA_png_warning(png_ptr, m);
...
__attribute__((__malloc__)) png_structp MAGMA_png_create_png_struct (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn, png_error_ptr warn_fn, png_voidp mem_ptr, png_malloc_ptr malloc_fn, png_free_ptr free_fn)
...

{
   ...
   memset(&create_struct, 0, (sizeof create_struct));
      ...
      MAGMA_png_set_mem_fn(&create_struct, mem_ptr, malloc_fn, free_fn);
# 299 "/benchmark/project/libpng/repo/png.c"
   MAGMA_png_set_error_fn(&create_struct, error_ptr, error_fn, warn_fn);
...
__attribute__((__malloc__)) png_infop MAGMA_png_create_info_struct (png_const_structrp png_ptr)

{
   ...
   info_ptr = (MAGMA_png_malloc_base(png_ptr, (sizeof *info_ptr)));
...
# 385 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_destroy_info_struct(png_const_structrp png_ptr, png_infopp info_ptr_ptr)
{
   ...
   if (info_ptr != ((void*)0))
   {
      ...
      *info_ptr_ptr = ((void*)0);
      ...
      MAGMA_png_free_data(png_ptr, info_ptr, 0xffffU, -1);
      memset(info_ptr, 0, (sizeof *info_ptr));
      MAGMA_png_free(png_ptr, info_ptr);
   }
}
# 423 "/benchmark/project/libpng/repo/png.c"
void MAGMA_png_info_init_3 (png_infopp ptr_ptr, size_t png_info_struct_size)
...

{
   ...
   if ((sizeof (png_info)) > png_info_struct_size)
   {
      *ptr_ptr = ((void*)0);
      ...
      free(info_ptr);
      info_ptr = (MAGMA_png_malloc_base(((void*)0), (sizeof *info_ptr)));
...
void
MAGMA_png_data_freer(png_const_structrp png_ptr, png_inforp info_ptr,
    int freer, png_uint_32 mask)
{
   ...
   if (freer == 1)
      ...
      MAGMA_png_error(png_ptr, "Unknown freer parameter in png_data_freer");
}

void
MAGMA_png_free_data(png_const_structrp png_ptr, png_inforp info_ptr, png_uint_32 mask,
    int num)
{
   ((void)0);
   ...
   if (((mask & 0x0100U) & info_ptr->free_me) != 0)
   {
   ...
   if (((mask & 0x0080U) & info_ptr->free_me) != 0)
   {
      ...
      if (info_ptr->pcal_params != ((void*)0))
         {
            ...
            for (i = 0; i < info_ptr->pcal_nparams; i++)
               MAGMA_png_free(png_ptr, info_ptr->pcal_params[i]);

            MAGMA_png_free(png_ptr, info_ptr->pcal_params);
   ...
   if (((mask & 0x0010U) & info_ptr->free_me) != 0)
   {
   ...
   if (info_ptr->splt_palettes != ((void*)0) &&
       ((mask & 0x0020U) & info_ptr->free_me) != 0)
   {
      if (num != -1)
      {
         MAGMA_png_free(png_ptr, info_ptr->splt_palettes[num].name);
         MAGMA_png_free(png_ptr, info_ptr->splt_palettes[num].entries);
      ...
      else
      {
         ...
         {
            MAGMA_png_free(png_ptr, info_ptr->splt_palettes[i].name);
            MAGMA_png_free(png_ptr, info_ptr->splt_palettes[i].entries);
         }

         MAGMA_png_free(png_ptr, info_ptr->splt_palettes);
   ...
   if (info_ptr->unknown_chunks != ((void*)0) &&
       ((mask & 0x0200U) & info_ptr->free_me) != 0)
   {
      if (num != -1)
      {
          MAGMA_png_free(png_ptr, info_ptr->unknown_chunks[num].data);
      ...
      else
      {
         ...
         for (i = 0; i < info_ptr->unknown_chunks_num; i++)
            MAGMA_png_free(png_ptr, info_ptr->unknown_chunks[i].data);

         MAGMA_png_free(png_ptr, info_ptr->unknown_chunks);
   ...
   if (((mask & 0x8000U) & info_ptr->free_me) != 0)
   {
      ...
      if (info_ptr->exif)
      {
         MAGMA_png_free(png_ptr, info_ptr->exif);
         info_ptr->exif = ((void*)0);
      }
   ...
   if (((mask & 0x0040U) & info_ptr->free_me) != 0)
   {
      if (info_ptr->row_pointers != ((void*)0))
      {
         ...
         for (row = 0; row < info_ptr->height; row++)
            MAGMA_png_free(png_ptr, info_ptr->row_pointers[row]);

         MAGMA_png_free(png_ptr, info_ptr->row_pointers);
...
png_voidp
MAGMA_png_get_io_ptr(png_const_structrp png_ptr)
{
   if (png_ptr == ((void*)0))
      return (((void*)0));
...
# 702 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_init_io(png_structrp png_ptr, png_FILE_p fp)
{
   ((void)0);
...
# 725 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_save_int_32(png_bytep buf, png_int_32 i)
{
   MAGMA_png_save_uint_32(buf, (png_uint_32)i);
}
...
int
MAGMA_png_convert_to_rfc1123_buffer(char out[29], png_const_timep ptime)
{
...

   {
      ...
      if (pos < 28) out[pos++] = (' ');
      pos = MAGMA_png_safecat(out, 29, pos, (short_months[(ptime->month - 1)]));
      if (pos < 28) out[pos++] = (' ');
      pos = MAGMA_png_safecat(out, 29, pos, (MAGMA_png_format_number(number_buf, number_buf + (sizeof number_buf), 1, (ptime->year))));
      if (pos < 28) out[pos++] = (' ');
      pos = MAGMA_png_safecat(out, 29, pos, (MAGMA_png_format_number(number_buf, number_buf + (sizeof number_buf), 2, ((unsigned)ptime->hour))));
      if (pos < 28) out[pos++] = (':');
      pos = MAGMA_png_safecat(out, 29, pos, (MAGMA_png_format_number(number_buf, number_buf + (sizeof number_buf), 2, ((unsigned)ptime->minute))));
      if (pos < 28) out[pos++] = (':');
      pos = MAGMA_png_safecat(out, 29, pos, (MAGMA_png_format_number(number_buf, number_buf + (sizeof number_buf), 2, ((unsigned)ptime->second))));
      pos = MAGMA_png_safecat(out, 29, pos, (" +0000"));
      (void)pos;
...
png_const_charp
MAGMA_png_convert_to_rfc1123(png_structrp png_ptr, png_const_timep ptime)
{
   if (png_ptr != ((void*)0))
   {

      if (MAGMA_png_convert_to_rfc1123_buffer(png_ptr->time_buffer, ptime) == 0)
         MAGMA_png_warning(png_ptr, "Ignoring invalid time value");
...
png_const_charp
MAGMA_png_get_copyright(png_const_structrp png_ptr)
{
   (void)png_ptr;
...
# 826 "/benchmark/project/libpng/repo/png.c"
}
# 836 "/benchmark/project/libpng/repo/png.c"
png_const_charp
MAGMA_png_get_libpng_ver(png_const_structrp png_ptr)
{

   return MAGMA_png_get_header_ver(png_ptr);
}

png_const_charp
MAGMA_png_get_header_ver(png_const_structrp png_ptr)
{
...
png_const_charp
MAGMA_png_get_header_version(png_const_structrp png_ptr)
{

   (void)png_ptr;

   return " libpng version 1.6.38.git\n"
...
# 874 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_build_grayscale_palette(int bit_depth, png_colorp palette)
{
   int num_palette;
   int color_inc;
   int i;
...
int
MAGMA_png_handle_as_unknown(png_const_structrp png_ptr, png_const_bytep chunk_name)
{
...
int
MAGMA_png_chunk_unknown_handling(png_const_structrp png_ptr, png_uint_32 chunk_name)
{
   ...
   return MAGMA_png_handle_as_unknown(png_ptr, chunk_string);
}
...
int
MAGMA_png_reset_zstream(png_structrp png_ptr)
{
   if (png_ptr == ((void*)0))
      return (-2);
...
png_uint_32
MAGMA_png_access_version_number(void)
{

   return((png_uint_32)10638);
}
...
void
MAGMA_png_zstream_error(png_structrp png_ptr, int ret)
{
...
# 1081 "/benchmark/project/libpng/repo/png.c"
{
   png_fixed_point gtest;

   if ((colorspace->flags & 0x0001) != 0 &&
       (MAGMA_png_muldiv(&gtest, colorspace->gamma, 100000, gAMA) == 0 ||
      MAGMA_png_gamma_significant(gtest) != 0))
   {
      ...
      {
         MAGMA_png_chunk_report(png_ptr, "gamma value does not match sRGB",
             2);
      ...
      {
         MAGMA_png_chunk_report(png_ptr, "gamma value does not match libpng estimate",
             0);
         return from == 1;
      }
   }
...
void
MAGMA_png_colorspace_set_gamma(png_const_structrp png_ptr,
    png_colorspacerp colorspace, png_fixed_point gAMA)
{
# 1128 "/benchmark/project/libpng/repo/png.c"
   ...
   else if ((png_ptr->mode & 0x8000U) != 0 &&
      (colorspace->flags & 0x0008) != 0)
      errmsg = "duplicate";



   else if ((colorspace->flags & 0x8000) != 0)
      return;
   ...
   MAGMA_png_chunk_report(png_ptr, errmsg, 1);
}

void
MAGMA_png_colorspace_sync_info(png_const_structrp png_ptr, png_inforp info_ptr)
{
   if ((info_ptr->colorspace.flags & 0x8000) != 0)
   {

      info_ptr->valid &= ~(0x0001U|0x0004U|0x0800U|
         0x1000U);



      MAGMA_png_free_data(png_ptr, info_ptr, 0x0010U, -1 );
   ...
   else
   {
      ...
      if ((info_ptr->colorspace.flags & 0x0080) != 0)
         info_ptr->valid |= 0x0800U;

      else
         info_ptr->valid &= ~0x0800U;

      if ((info_ptr->colorspace.flags & 0x0002) != 0)
      ...
      if ((info_ptr->colorspace.flags & 0x0001) != 0)
...
void
MAGMA_png_colorspace_sync(png_const_structrp png_ptr, png_inforp info_ptr)
{
   if (info_ptr == ((void*)0))
      return;

   info_ptr->colorspace = png_ptr->colorspace;
   MAGMA_png_colorspace_sync_info(png_ptr, info_ptr);
}
# 1232 "/benchmark/project/libpng/repo/png.c"
static int
png_xy_from_XYZ(png_xy *xy, const png_XYZ *XYZ)
{
   ...
   if (MAGMA_png_muldiv(&xy->redx, XYZ->red_X, 100000, d) == 0)
      return 1;
   if (MAGMA_png_muldiv(&xy->redy, XYZ->red_Y, 100000, d) == 0)
      return 1;
   dwhite = d;
   whiteX = XYZ->red_X;
   whiteY = XYZ->red_Y;
   ...
   if (MAGMA_png_muldiv(&xy->greenx, XYZ->green_X, 100000, d) == 0)
      return 1;
   if (MAGMA_png_muldiv(&xy->greeny, XYZ->green_Y, 100000, d) == 0)
      return 1;
   dwhite += d;
   whiteX += XYZ->green_X;
   whiteY += XYZ->green_Y;
   ...
   if (MAGMA_png_muldiv(&xy->bluex, XYZ->blue_X, 100000, d) == 0)
      return 1;
   if (MAGMA_png_muldiv(&xy->bluey, XYZ->blue_Y, 100000, d) == 0)
      return 1;
   dwhite += d;
   whiteX += XYZ->blue_X;
   whiteY += XYZ->blue_Y;
   ...
   if (MAGMA_png_muldiv(&xy->whitex, whiteX, 100000, dwhite) == 0)
      return 1;
   if (MAGMA_png_muldiv(&xy->whitey, whiteY, 100000, dwhite) == 0)
      return 1;
...
png_XYZ_from_xy(png_XYZ *XYZ, const png_xy *xy)
{
   ...
   if (xy->whitey < 5 || xy->whitey > 100000 -xy->whitex) return 1;
# 1474 "/benchmark/project/libpng/repo/png.c"
   if (MAGMA_png_muldiv(&left, xy->greenx-xy->bluex, xy->redy - xy->bluey, 7) == 0)
      return 2;
   if (MAGMA_png_muldiv(&right, xy->greeny-xy->bluey, xy->redx - xy->bluex, 7) == 0)
      return 2;
   denominator = left - right;


   if (MAGMA_png_muldiv(&left, xy->greenx-xy->bluex, xy->whitey-xy->bluey, 7) == 0)
      return 2;
   if (MAGMA_png_muldiv(&right, xy->greeny-xy->bluey, xy->whitex-xy->bluex, 7) == 0)
      return 2;
   ...
   if (MAGMA_png_muldiv(&red_inverse, xy->whitey, denominator, left-right) == 0 ||
       red_inverse <= xy->whitey )
      return 1;


   if (MAGMA_png_muldiv(&left, xy->redy-xy->bluey, xy->whitex-xy->bluex, 7) == 0)
      return 2;
   if (MAGMA_png_muldiv(&right, xy->redx-xy->bluex, xy->whitey-xy->bluey, 7) == 0)
      return 2;
   if (MAGMA_png_muldiv(&green_inverse, xy->whitey, denominator, left-right) == 0 ||
   ...
   blue_scale = MAGMA_png_reciprocal(xy->whitey) - MAGMA_png_reciprocal(red_inverse) -
       MAGMA_png_reciprocal(green_inverse);
   if (blue_scale <= 0)
      return 1;



   if (MAGMA_png_muldiv(&XYZ->red_X, xy->redx, 100000, red_inverse) == 0)
      return 1;
   if (MAGMA_png_muldiv(&XYZ->red_Y, xy->redy, 100000, red_inverse) == 0)
      return 1;
   if (MAGMA_png_muldiv(&XYZ->red_Z, 100000 - xy->redx - xy->redy, 100000,
       red_inverse) == 0)
      return 1;

   if (MAGMA_png_muldiv(&XYZ->green_X, xy->greenx, 100000, green_inverse) == 0)
      return 1;
   if (MAGMA_png_muldiv(&XYZ->green_Y, xy->greeny, 100000, green_inverse) == 0)
      return 1;
   if (MAGMA_png_muldiv(&XYZ->green_Z, 100000 - xy->greenx - xy->greeny, 100000,
       green_inverse) == 0)
      return 1;

   if (MAGMA_png_muldiv(&XYZ->blue_X, xy->bluex, blue_scale, 100000) == 0)
      return 1;
   if (MAGMA_png_muldiv(&XYZ->blue_Y, xy->bluey, blue_scale, 100000) == 0)
      return 1;
   if (MAGMA_png_muldiv(&XYZ->blue_Z, 100000 - xy->bluex - xy->bluey, blue_scale,
       100000) == 0)
      return 1;
...
png_XYZ_normalize(png_XYZ *XYZ)
{
   ...
   if (Y != 100000)
   {
      if (MAGMA_png_muldiv(&XYZ->red_X, XYZ->red_X, 100000, Y) == 0)
         return 1;
      if (MAGMA_png_muldiv(&XYZ->red_Y, XYZ->red_Y, 100000, Y) == 0)
         return 1;
      if (MAGMA_png_muldiv(&XYZ->red_Z, XYZ->red_Z, 100000, Y) == 0)
         return 1;

      if (MAGMA_png_muldiv(&XYZ->green_X, XYZ->green_X, 100000, Y) == 0)
         return 1;
      if (MAGMA_png_muldiv(&XYZ->green_Y, XYZ->green_Y, 100000, Y) == 0)
         return 1;
      if (MAGMA_png_muldiv(&XYZ->green_Z, XYZ->green_Z, 100000, Y) == 0)
         return 1;

      if (MAGMA_png_muldiv(&XYZ->blue_X, XYZ->blue_X, 100000, Y) == 0)
         return 1;
      if (MAGMA_png_muldiv(&XYZ->blue_Y, XYZ->blue_Y, 100000, Y) == 0)
         return 1;
      if (MAGMA_png_muldiv(&XYZ->blue_Z, XYZ->blue_Z, 100000, Y) == 0)
         return 1;
   }
...
png_colorspace_endpoints_match(const png_xy *xy1, const png_xy *xy2, int delta)
{
   ...
   if (( (xy1->whitex) < (xy2->whitex)-(delta) || (xy1->whitex) > (xy2->whitex)+(delta) ) ||
...
# 1617 "/benchmark/project/libpng/repo/png.c"
static int
    ...
    int preferred)
{
       ...
       (colorspace->flags & 0x0002) != 0)
   {
      ...
      {
         colorspace->flags |= 0x8000;
         MAGMA_png_benign_error(png_ptr, "inconsistent chromaticities");
         return 0;
      }
...
int
MAGMA_png_colorspace_set_chromaticities(png_const_structrp png_ptr,
    png_colorspacerp colorspace, const png_xy *xy, int preferred)
{
   ...
   switch (png_colorspace_check_xy(&XYZ, xy))
   {
      ...
      case 1:
         ...
         colorspace->flags |= 0x8000;
         MAGMA_png_benign_error(png_ptr, "invalid chromaticities");
         break;
      ...
      default:
         ...
         colorspace->flags |= 0x8000;
         MAGMA_png_error(png_ptr, "internal error checking chromaticities");
   }
...
int
MAGMA_png_colorspace_set_endpoints(png_const_structrp png_ptr,
    png_colorspacerp colorspace, const png_XYZ *XYZ_in, int preferred)
{
   ...
   switch (png_colorspace_check_XYZ(&xy, &XYZ))
   {
      ...
      case 1:
         ...
         colorspace->flags |= 0x8000;
         MAGMA_png_benign_error(png_ptr, "invalid end points");
         break;
    ...
    png_const_charp name, png_alloc_size_t value, png_const_charp reason)
{
   ...
   pos = MAGMA_png_safecat(message, (sizeof message), 0, "profile '");
   pos = MAGMA_png_safecat(message, pos+79, pos, name);
   pos = MAGMA_png_safecat(message, (sizeof message), pos, "': ");
   if (is_ICC_signature(value) != 0)
   {
   ...
   else
      {
         ...
         pos = MAGMA_png_safecat(message, (sizeof message), pos,
             MAGMA_png_format_number(number, number+(sizeof number),
             3, value));
         pos = MAGMA_png_safecat(message, (sizeof message), pos, "h: ");
      }


   pos = MAGMA_png_safecat(message, (sizeof message), pos, reason);
   (void)pos;
   ...
   MAGMA_png_chunk_report(png_ptr, message,
...
int
MAGMA_png_colorspace_set_sRGB(png_const_structrp png_ptr, png_colorspacerp colorspace,
    int intent)
{
# 1887 "/benchmark/project/libpng/repo/png.c"
   ...
   if ((colorspace->flags & 0x8000) != 0)
      return 0;
# 1908 "/benchmark/project/libpng/repo/png.c"
   ...
   {
      MAGMA_png_benign_error(png_ptr, "duplicate sRGB information ignored");
      return 0;
   }
   ...
   if ((colorspace->flags & 0x0002) != 0 &&
       ...
       100))
      MAGMA_png_chunk_report(png_ptr, "cHRM chunk does not match sRGB",
         2);
...
# 1966 "/benchmark/project/libpng/repo/png.c"
...
int
MAGMA_png_icc_check_length(png_const_structrp png_ptr, png_colorspacerp colorspace,
    png_const_charp name, png_uint_32 profile_length)
{
   if (!icc_check_length(png_ptr, colorspace, name, profile_length))
      return 0;
# 1994 "/benchmark/project/libpng/repo/png.c"
      else if (png_ptr->user_chunk_malloc_max > 0 &&
               png_ptr->user_chunk_malloc_max < profile_length)
         return png_icc_profile_error(png_ptr, colorspace, name, profile_length,
             "exceeds application limits");
# 2009 "/benchmark/project/libpng/repo/png.c"
   return 1;
}


int
MAGMA_png_icc_check_header(png_const_structrp png_ptr, png_colorspacerp colorspace,
    png_const_charp name, png_uint_32 profile_length,
...
# 2133 "/benchmark/project/libpng/repo/png.c"
...
int
MAGMA_png_icc_check_tag_table(png_const_structrp png_ptr, png_colorspacerp colorspace,
    png_const_charp name, png_uint_32 profile_length,
...
# 2224 "/benchmark/project/libpng/repo/png.c"
...
# 2286 "/benchmark/project/libpng/repo/png.c"
...
# 2297 "/benchmark/project/libpng/repo/png.c"
...
{
# 2318 "/benchmark/project/libpng/repo/png.c"
   ...
   for (i=0; i < (sizeof png_sRGB_checks) / (sizeof png_sRGB_checks[0]); ++i)
   {
      ...
      {
# 2349 "/benchmark/project/libpng/repo/png.c"
         if (length == 0)
         {
            ...
            if (adler == png_sRGB_checks[i].adler)
            {
...

               {
                  if (png_sRGB_checks[i].is_broken != 0)
                  {
                     ...
                     MAGMA_png_chunk_report(png_ptr, "known incorrect sRGB profile",
                         2);
                  }
                  ...
                  {
                     MAGMA_png_chunk_report(png_ptr,
...
void
MAGMA_png_icc_set_sRGB(png_const_structrp png_ptr,
    png_colorspacerp colorspace, png_const_bytep profile, uLong adler)
{
   ...
   if (png_compare_ICC_profile_with_sRGB(png_ptr, profile, adler) != 0)
      (void)MAGMA_png_colorspace_set_sRGB(png_ptr, colorspace,
...
int
MAGMA_png_colorspace_set_ICC(png_const_structrp png_ptr, png_colorspacerp colorspace,
    ...
    int color_type)
{
   ...
   if (icc_check_length(png_ptr, colorspace, name, profile_length) != 0 &&
       MAGMA_png_icc_check_header(png_ptr, colorspace, name, profile_length, profile,
           color_type) != 0 &&
       MAGMA_png_icc_check_tag_table(png_ptr, colorspace, name, profile_length,
           profile) != 0)
   {


         MAGMA_png_icc_set_sRGB(png_ptr, colorspace, profile, 0);
...
void
MAGMA_png_colorspace_set_rgb_coefficients(png_structrp png_ptr)
{
      ...
      (png_ptr->colorspace.flags & 0x0002) != 0)
   {
      ...
      if (total > 0 &&
         r >= 0 && MAGMA_png_muldiv(&r, r, 32768, total) && r >= 0 && r <= 32768 &&
         g >= 0 && MAGMA_png_muldiv(&g, g, 32768, total) && g >= 0 && g <= 32768 &&
         b >= 0 && MAGMA_png_muldiv(&b, b, 32768, total) && b >= 0 && b <= 32768 &&
         r+g+b <= 32769)
      {
         ...
         MAGMA_png_error(png_ptr, "internal error handling cHRM->XYZ");
   }
}
...
void
MAGMA_png_check_IHDR(png_const_structrp png_ptr,
    ...
    int filter_type)
{
   ...
   if (width == 0)
   {
      MAGMA_png_warning(png_ptr, "Image width is zero in IHDR");
      error = 1;
   }

   if (width > ((png_uint_32)0x7fffffffL))
   {
      MAGMA_png_warning(png_ptr, "Invalid image width in IHDR");
      error = 1;
   }
   ...
   if (png_gt(((width + 7) & (~7U)),
       ((((size_t)(-1))
           ...
           - 1))
   {
# 2585 "/benchmark/project/libpng/repo/png.c"
      MAGMA_png_warning(png_ptr, "Image width is too large for this architecture");
      error = 1;
   }
   ...
   {
      MAGMA_png_warning(png_ptr, "Image width exceeds user limit in IHDR");
      error = 1;
   }

   if (height == 0)
   {
      MAGMA_png_warning(png_ptr, "Image height is zero in IHDR");
      error = 1;
   }

   if (height > ((png_uint_32)0x7fffffffL))
   {
      MAGMA_png_warning(png_ptr, "Invalid image height in IHDR");
      error = 1;
   }
   ...
   {
      MAGMA_png_warning(png_ptr, "Image height exceeds user limit in IHDR");
      error = 1;
   }
   ...
   {
      MAGMA_png_warning(png_ptr, "Invalid bit depth in IHDR");
      error = 1;
   }
   ...
   {
      MAGMA_png_warning(png_ptr, "Invalid color type in IHDR");
      error = 1;
   }
   ...
   {
      MAGMA_png_warning(png_ptr, "Invalid color type/bit depth combination in IHDR");
      error = 1;
   }

   if (interlace_type >= 2)
   {
      MAGMA_png_warning(png_ptr, "Unknown interlace method in IHDR");
      error = 1;
   }

   if (compression_type != 0)
   {
      MAGMA_png_warning(png_ptr, "Unknown compression method in IHDR");
      error = 1;
   }
# 2667 "/benchmark/project/libpng/repo/png.c"
   if ((png_ptr->mode & 0x1000U) != 0 &&
       png_ptr->mng_features_permitted != 0)
      MAGMA_png_warning(png_ptr, "MNG features are not allowed in a PNG datastream");

   if (filter_type != 0)
   {
      if (!((png_ptr->mng_features_permitted & 0x04) != 0 &&
          (filter_type == 64) &&
          ((png_ptr->mode & 0x1000U) == 0) &&
          (color_type == (2) ||
          color_type == (2 | 4))))
      {
         MAGMA_png_warning(png_ptr, "Unknown filter method in IHDR");
         error = 1;
      }

      if ((png_ptr->mode & 0x1000U) != 0)
      {
         MAGMA_png_warning(png_ptr, "Invalid filter method in IHDR");
         error = 1;
      }
   }
# 2698 "/benchmark/project/libpng/repo/png.c"
   if (error == 1)
      MAGMA_png_error(png_ptr, "Invalid IHDR data");
}
# 2711 "/benchmark/project/libpng/repo/png.c"
int
MAGMA_png_check_fp_number(png_const_charp string, size_t size, int *statep,
...
int
MAGMA_png_check_fp_string(png_const_charp string, size_t size)
{
   int state=0;
   size_t char_index=0;

   if (MAGMA_png_check_fp_number(string, size, &state, &char_index) != 0 &&
...
# 2902 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_ascii_from_fp(png_const_structrp png_ptr, png_charp ascii, size_t size,
    double fp, unsigned int precision)
{
   ...
   if (size >= precision+5)
   {
      ...
      if (fp >= 2.2250738585072014e-308 && fp <= 1.7976931348623157e+308)
      {
         int exp_b10;
         double base;
# 2942 "/benchmark/project/libpng/repo/png.c"
...
# 2970 "/benchmark/project/libpng/repo/png.c"
         fp /= base;
         while (fp >= 1)
         {
            fp /= 10; ++exp_b10;
...
# 3137 "/benchmark/project/libpng/repo/png.c"
   ...
   MAGMA_png_error(png_ptr, "ASCII conversion buffer too small");
}
# 3232 "/benchmark/project/libpng/repo/png.c"
void
MAGMA_png_ascii_from_fixed(png_const_structrp png_ptr, png_charp ascii,
...
# 3315 "/benchmark/project/libpng/repo/png.c"
png_fixed_point
MAGMA_png_fixed(png_const_structrp png_ptr, double fp, png_const_charp text)
{
   double r = floor(100000 * fp + .5);

   if (r > 2147483647. || r < -2147483648.)
      MAGMA_png_fixed_error(png_ptr, text);
...
# 3348 "/benchmark/project/libpng/repo/png.c"
int
MAGMA_png_muldiv(png_fixed_point_p res, png_fixed_point a, png_int_32 times,
    png_int_32 divisor)
{
...
# 3457 "/benchmark/project/libpng/repo/png.c"
      }
   }

   return 0;
}
# 3471 "/benchmark/project/libpng/repo/png.c"
png_fixed_point
MAGMA_png_muldiv_warn(png_const_structrp png_ptr, png_fixed_point a, png_int_32 times,
    png_int_32 divisor)
{
   png_fixed_point result;

   if (MAGMA_png_muldiv(&result, a, times, divisor) != 0)
      return result;

   MAGMA_png_warning(png_ptr, "fixed point overflow ignored");
   return 0;
}
...
png_fixed_point
MAGMA_png_reciprocal(png_fixed_point a)
{
...
int
MAGMA_png_gamma_significant(png_fixed_point gamma_val)
{
...
png_fixed_point
MAGMA_png_reciprocal2(png_fixed_point a, png_fixed_point b)
{
...
# 3568 "/benchmark/project/libpng/repo/png.c"
   return 0;
}
# 3863 "/benchmark/project/libpng/repo/png.c"
png_byte
MAGMA_png_gamma_8bit_correct(unsigned int value, png_fixed_point gamma_val)
{
   if (value > 0 && value < 255)
   {
# 3893 "/benchmark/project/libpng/repo/png.c"
         double r = floor(255*pow((int) value/255.,gamma_val*.00001)+.5);
         return (png_byte)r;
# 3905 "/benchmark/project/libpng/repo/png.c"
   }
...
png_uint_16
MAGMA_png_gamma_16bit_correct(unsigned int value, png_fixed_point gamma_val)
{
...
# 3935 "/benchmark/project/libpng/repo/png.c"
   }
...
png_uint_16
MAGMA_png_gamma_correct(png_structrp png_ptr, unsigned int value,
    png_fixed_point gamma_val)
{
   if (png_ptr->bit_depth == 8)
      return MAGMA_png_gamma_8bit_correct(value, gamma_val);


   else
      return MAGMA_png_gamma_16bit_correct(value, gamma_val);




}
# 3971 "/benchmark/project/libpng/repo/png.c"
static void
    ...
    unsigned int shift, png_fixed_point gamma_val)
{
   ...
   png_uint_16pp table = *ptable =
       (png_uint_16pp)MAGMA_png_calloc(png_ptr, num * (sizeof (png_uint_16p)));

   for (i = 0; i < num; i++)
   {
      png_uint_16p sub_table = table[i] =
          (png_uint_16p)MAGMA_png_malloc(png_ptr, 256 * (sizeof (png_uint_16)));




      if (MAGMA_png_gamma_significant(gamma_val) != 0)
      {
# 4008 "/benchmark/project/libpng/repo/png.c"
         unsigned int j;
         for (j = 0; j < 256; j++)
         {
    ...
    unsigned int shift, png_fixed_point gamma_val)
{
   ...
   for (i = 0; i < num; i++)
      table[i] = (png_uint_16p)MAGMA_png_malloc(png_ptr,
          256 * (sizeof (png_uint_16)));
# 4084 "/benchmark/project/libpng/repo/png.c"
   last = 0;
   for (i = 0; i < 255; ++i)
   {
      ...
      png_uint_32 bound = MAGMA_png_gamma_16bit_correct(out+128U, gamma_val);
...
{
   unsigned int i;
   png_bytep table = *ptable = (png_bytep)MAGMA_png_malloc(png_ptr, 256);

   if (MAGMA_png_gamma_significant(gamma_val) != 0)
      for (i=0; i<256; i++)
         table[i] = MAGMA_png_gamma_8bit_correct(i, gamma_val);
...
void
MAGMA_png_destroy_gamma_table(png_structrp png_ptr)
{
   MAGMA_png_free(png_ptr, png_ptr->gamma_table);
   ...
   if (png_ptr->gamma_16_table != ((void*)0))
   {
      ...
      for (i = 0; i < istop; i++)
      {
         MAGMA_png_free(png_ptr, png_ptr->gamma_16_table[i]);
      }
   MAGMA_png_free(png_ptr, png_ptr->gamma_16_table);
   ...
   MAGMA_png_free(png_ptr, png_ptr->gamma_from_1);
   png_ptr->gamma_from_1 = ((void*)0);
   MAGMA_png_free(png_ptr, png_ptr->gamma_to_1);
   ...
   if (png_ptr->gamma_16_from_1 != ((void*)0))
   {
      ...
      for (i = 0; i < istop; i++)
      {
         MAGMA_png_free(png_ptr, png_ptr->gamma_16_from_1[i]);
      }
   MAGMA_png_free(png_ptr, png_ptr->gamma_16_from_1);
   ...
   if (png_ptr->gamma_16_to_1 != ((void*)0))
   {
      ...
      for (i = 0; i < istop; i++)
      {
         MAGMA_png_free(png_ptr, png_ptr->gamma_16_to_1[i]);
      }
   MAGMA_png_free(png_ptr, png_ptr->gamma_16_to_1);
...
void
MAGMA_png_build_gamma_table(png_structrp png_ptr, int bit_depth)
{
   ((void)0);
   ...
   {
      MAGMA_png_warning(png_ptr, "gamma table being rebuilt");
   ...
   if (bit_depth <= 8)
   {
      png_build_8bit_table(png_ptr, &png_ptr->gamma_table,
          ...
          MAGMA_png_reciprocal2(png_ptr->colorspace.gamma,
          png_ptr->screen_gamma) : 100000);




      if ((png_ptr->transformations & (0x0080U | 0x600000U)) != 0)
      {
         png_build_8bit_table(png_ptr, &png_ptr->gamma_to_1,
             MAGMA_png_reciprocal(png_ptr->colorspace.gamma));

         png_build_8bit_table(png_ptr, &png_ptr->gamma_from_1,
             png_ptr->screen_gamma > 0 ?
             MAGMA_png_reciprocal(png_ptr->screen_gamma) :
...
# 4270 "/benchmark/project/libpng/repo/png.c"
      ...
      if ((png_ptr->transformations & (0x0400U | 0x4000000U)) != 0)
          ...
          png_ptr->screen_gamma > 0 ? MAGMA_png_reciprocal2(png_ptr->colorspace.gamma,
          png_ptr->screen_gamma) : 100000);
      ...
      if ((png_ptr->transformations & (0x0080U | 0x600000U)) != 0)
      {
         ...
         png_build_16bit_table(png_ptr, &png_ptr->gamma_16_from_1, shift,
             png_ptr->screen_gamma > 0 ? MAGMA_png_reciprocal(png_ptr->screen_gamma) :
             png_ptr->colorspace.gamma );
      }
...
int
MAGMA_png_set_option(png_structrp png_ptr, int option, int onoff)
{
   if (png_ptr != ((void*)0) && option >= 0 && option < 12 &&
      (option & 1) == 0)
   {
...
# 4373 "/benchmark/project/libpng/repo/png.c"
const png_uint_16 MAGMA_png_sRGB_table[256] =
{
...
const png_uint_16 MAGMA_png_sRGB_base[512] =
{
...
const png_byte MAGMA_png_sRGB_delta[512] =
{
...
png_image_free_function(png_voidp argument)
{
   ...
   c = *cp;
   image->opaque = &c;
   MAGMA_png_free(c.png_ptr, cp);


   if (c.for_write != 0)
   {

         MAGMA_png_destroy_write_struct(&c.png_ptr, &c.info_ptr);
   ...
   else
   {
         ...
         MAGMA_png_destroy_read_struct(&c.png_ptr, &c.info_ptr, ((void*)0));
...
void
MAGMA_png_image_free(png_imagep image)
{
...
int
MAGMA_png_image_error(png_imagep image, png_const_charp error_message)
{

   MAGMA_png_safecat(image->message, (sizeof image->message), 0, error_message);
