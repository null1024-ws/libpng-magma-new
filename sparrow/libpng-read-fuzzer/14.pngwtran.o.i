# 1 "/benchmark/project/libpng/repo/pngwtran.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngwtran.c" 2
# 14 "/benchmark/project/libpng/repo/pngwtran.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 15 "/benchmark/project/libpng/repo/pngwtran.c" 2
# 24 "/benchmark/project/libpng/repo/pngwtran.c"
static void
...
# 171 "/benchmark/project/libpng/repo/pngwtran.c"
static void
...

   {
      if (row_info->color_type == (2 | 4))
      {
         ...
         else
         {
            ...
            for (i = 0, sp = dp = row; i < row_width; i++)
            {
# 448 "/benchmark/project/libpng/repo/pngwtran.c"
               sp+=6; dp = sp;
               *(dp++) = (png_byte)(255 - *(sp++));
               *dp = (png_byte)(255 - *(sp++));
            }
...
void
MAGMA_png_do_write_transformations(png_structrp png_ptr, png_row_infop row_info)
{
   ((void)0);
