# 1 "/benchmark/project/libpng/repo/pngtrans.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngtrans.c" 2
# 14 "/benchmark/project/libpng/repo/pngtrans.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 15 "/benchmark/project/libpng/repo/pngtrans.c" 2
...
void
MAGMA_png_set_bgr(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_swap(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_packing(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_packswap(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_shift(png_structrp png_ptr, png_const_color_8p true_bits)
{
   ((void)0);
...
int
MAGMA_png_set_interlace_handling(png_structrp png_ptr)
{
   ((void)0);
...
# 119 "/benchmark/project/libpng/repo/pngtrans.c"
void
MAGMA_png_set_filler(png_structrp png_ptr, png_uint_32 filler, int filler_loc)
{
   ((void)0);
   ...
   {
# 141 "/benchmark/project/libpng/repo/pngtrans.c"
...
void
MAGMA_png_set_add_alpha(png_structrp png_ptr, png_uint_32 filler, int filler_loc)
{
   ((void)0);
   ...
   MAGMA_png_set_filler(png_ptr, filler, filler_loc);
...
void
MAGMA_png_set_swap_alpha(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_invert_alpha(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_set_invert_mono(png_structrp png_ptr)
{
   ((void)0);
...
void
MAGMA_png_do_invert(png_row_infop row_info, png_bytep row)
{
   ((void)0);
...
void
MAGMA_png_do_swap(png_row_infop row_info, png_bytep row)
{
   ((void)0);
...
void
MAGMA_png_do_packswap(png_row_infop row_info, png_bytep row)
{
   ((void)0);
...
# 494 "/benchmark/project/libpng/repo/pngtrans.c"
void
MAGMA_png_do_strip_channel(png_row_infop row_info, png_bytep row, int at_start)
{
   png_bytep sp = row;
   png_bytep dp = row;
   png_bytep ep = row + row_info->rowbytes;
# 510 "/benchmark/project/libpng/repo/pngtrans.c"
...
void
MAGMA_png_do_bgr(png_row_infop row_info, png_bytep row)
{
   ((void)0);
...
void
MAGMA_png_do_check_palette_indexes(png_structrp png_ptr, png_row_infop row_info)
{
...
void
MAGMA_png_set_user_transform_info(png_structrp png_ptr, png_voidp
...
# 832 "/benchmark/project/libpng/repo/pngtrans.c"
png_voidp
MAGMA_png_get_user_transform_ptr(png_const_structrp png_ptr)
{
   if (png_ptr == ((void*)0))
      return (((void*)0));
...
png_uint_32
MAGMA_png_get_current_row_number(png_const_structrp png_ptr)
{
...
png_byte
MAGMA_png_get_current_pass_number(png_const_structrp png_ptr)
{
   if (png_ptr != ((void*)0))
      return png_ptr->pass;
   return 8;
