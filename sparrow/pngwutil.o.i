# 1 "/benchmark/project/libpng/repo/pngwutil.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 341 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/benchmark/project/libpng/repo/pngwutil.c" 2
# 14 "/benchmark/project/libpng/repo/pngwutil.c"
# 1 "./pngpriv.h" 1
# 44 "./pngpriv.h"
...
# 1 "./pngdebug.h" 1
# 2146 "./pngpriv.h" 2
# 15 "/benchmark/project/libpng/repo/pngwutil.c" 2
...
void
MAGMA_png_save_uint_32(png_bytep buf, png_uint_32 i)
{
...
void
MAGMA_png_save_uint_16(png_bytep buf, unsigned int i)
{
   buf[0] = (png_byte)((i >> 8) & 0xffU);
   buf[1] = (png_byte)( i & 0xffU);
}
# 50 "/benchmark/project/libpng/repo/pngwutil.c"
void
MAGMA_png_write_sig(png_structrp png_ptr)
{
   ...
   MAGMA_png_write_data(png_ptr, &png_signature[png_ptr->sig_bytes],
    ...
    png_uint_32 length)
{
   ...
   MAGMA_png_save_uint_32(buf, length);
   MAGMA_png_save_uint_32(buf + 4, chunk_name);
   MAGMA_png_write_data(png_ptr, buf, 8);
...
void
MAGMA_png_write_chunk_start(png_structrp png_ptr, png_const_bytep chunk_string,
    png_uint_32 length)
{
...
void
MAGMA_png_write_chunk_data(png_structrp png_ptr, png_const_bytep data, size_t length)
{
   ...
   {
      MAGMA_png_write_data(png_ptr, data, length);




      MAGMA_png_calculate_crc(png_ptr, data, length);
   }
}


void
MAGMA_png_write_chunk_end(png_structrp png_ptr)
{
   png_byte buf[4];
   ...
   MAGMA_png_save_uint_32(buf, png_ptr->crc);

   MAGMA_png_write_data(png_ptr, buf, 4);
}
# 174 "/benchmark/project/libpng/repo/pngwutil.c"
static void
    ...
    png_const_bytep data, size_t length)
{
   ...
   if (length > ((png_uint_32)0x7fffffffL))
      MAGMA_png_error(png_ptr, "length exceeds PNG maximum");

   png_write_chunk_header(png_ptr, chunk_name, (png_uint_32)length);
   MAGMA_png_write_chunk_data(png_ptr, data, length);
   MAGMA_png_write_chunk_end(png_ptr);
}


void
MAGMA_png_write_chunk(png_structrp png_ptr, png_const_bytep chunk_string,
    png_const_bytep data, size_t length)
{
...
# 249 "/benchmark/project/libpng/repo/pngwutil.c"
static void
    ...
    png_alloc_size_t data_size)
{
   if (png_ptr->zowner != 0)
   {
      ...
      (void)MAGMA_png_safecat(msg, (sizeof msg), 10, " using zstream");
# 322 "/benchmark/project/libpng/repo/pngwutil.c"
         MAGMA_png_error(png_ptr, msg);
...
# 362 "/benchmark/project/libpng/repo/pngwutil.c"
      }
# 371 "/benchmark/project/libpng/repo/pngwutil.c"
      if (data_size <= 16384)
      {
         ...
         png_ptr->zlib_set_strategy != strategy))
      {
         if (deflateEnd(&png_ptr->zstream) != 0)
            MAGMA_png_warning(png_ptr, "deflateEnd failed (ignored)");
      ...
      {
         ret = deflateInit2_((&png_ptr->zstream),(level),(method),(windowBits),(memLevel), (strategy), "1.2.11", (int)sizeof(z_stream));
...
void
MAGMA_png_free_buffer_list(png_structrp png_ptr, png_compression_bufferp *listp)
{
   ...
   if (list != ((void*)0))
   {
      *listp = ((void*)0);
      ...
      do
      {
         ...
         MAGMA_png_free(png_ptr, list);
         list = next;
      }
      while (list != ((void*)0));
   }
}
# 469 "/benchmark/project/libpng/repo/pngwutil.c"
typedef struct
{
...
{
   int ret;
# 503 "/benchmark/project/libpng/repo/pngwutil.c"
...

   {
      ...
      do
      {
         ...
         if (png_ptr->zstream.avail_out == 0)
         {
            ...
            if (next == ((void*)0))
            {
               next = (MAGMA_png_malloc_base (png_ptr, (__builtin_offsetof(png_compression_buffer, output) + (png_ptr)->zbuffer_size)));
...
png_write_compressed_data_out(png_structrp png_ptr, compression_state *comp)
{
   ...
   for (;;)
   {
      ...
      MAGMA_png_write_chunk_data(png_ptr, output, avail);
   ...
   if (output_len > 0)
      MAGMA_png_error(png_ptr, "error writing ancillary chunked compressed data");
}
...
void
MAGMA_png_write_IHDR(png_structrp png_ptr, png_uint_32 width, png_uint_32 height,
    ...
    int interlace_type)
{
   ...
   switch (color_type)
   {
      ...
      case (2):
         ...
         if (is_invalid_depth)
            MAGMA_png_error(png_ptr, "Invalid bit depth for RGB image");
      ...
      case (2 | 1):
         switch (bit_depth)
         {
            ...
            default:
               MAGMA_png_error(png_ptr, "Invalid bit depth for paletted image");
         }
         break;
      ...
      case (4):
         ...
         if (is_invalid_depth)
            MAGMA_png_error(png_ptr, "Invalid bit depth for grayscale+alpha image");
      ...
      case (2 | 4):
         ...
         if (is_invalid_depth)
            MAGMA_png_error(png_ptr, "Invalid bit depth for RGBA image");

         png_ptr->channels = 4;
         break;

      default:
         MAGMA_png_error(png_ptr, "Invalid image color type specified");
   }

   if (compression_type != 0)
   {
      MAGMA_png_warning(png_ptr, "Invalid compression type specified");
      compression_type = 0;
   }
# 769 "/benchmark/project/libpng/repo/pngwutil.c"
   if (

       !((png_ptr->mng_features_permitted & 0x04) != 0 &&
       ...
       filter_type != 0)
   {
      MAGMA_png_warning(png_ptr, "Invalid filter type specified");
      filter_type = 0;
   }
   ...
   if (interlace_type != 0 &&
       interlace_type != 1)
   {
      MAGMA_png_warning(png_ptr, "Invalid interlace type specified");
      interlace_type = 1;
   }
   ...
   MAGMA_png_save_uint_32(buf, width);
   MAGMA_png_save_uint_32(buf + 4, height);
...
void
MAGMA_png_write_PLTE(png_structrp png_ptr, png_const_colorp palette,
    png_uint_32 num_pal)
{
       ...
       num_pal == 0) || num_pal > max_palette_length)
   {
      if (png_ptr->color_type == (2 | 1))
      {
         MAGMA_png_error(png_ptr, "Invalid number of colors in palette");
      }

      else
      {
         MAGMA_png_warning(png_ptr, "Invalid number of colors in palette");
         return;
      }
   }
   ...
   for (i = 0, pal_ptr = palette; i < num_pal; i++, pal_ptr++)
   {
      ...
      buf[1] = pal_ptr->green;
      buf[2] = pal_ptr->blue;
      MAGMA_png_write_chunk_data(png_ptr, buf, 3);
   }
# 909 "/benchmark/project/libpng/repo/pngwutil.c"
   MAGMA_png_write_chunk_end(png_ptr);
   png_ptr->mode |= 0x02;
}
# 930 "/benchmark/project/libpng/repo/pngwutil.c"
void
MAGMA_png_compress_IDAT(png_structrp png_ptr, png_const_bytep input,
    png_alloc_size_t input_len, int flush)
{
   if (png_ptr->zowner != (((png_uint_32)(73) << (24)) | ((png_uint_32)(68) << (16)) | ((png_uint_32)(65) << (8)) | ((png_uint_32)(84) << (0))))
   {
      ...
      {
         png_ptr->zbuffer_list = (MAGMA_png_malloc(png_ptr, (__builtin_offsetof(png_compression_buffer, output) + (png_ptr)->zbuffer_size)));

         png_ptr->zbuffer_list->next = ((void*)0);
      }

      else
         MAGMA_png_free_buffer_list(png_ptr, &png_ptr->zbuffer_list->next);
   ...
   for (;;)
   {
      ...
      if (ret == 0)
      {
         ...
         {
            if (flush == 4)
               MAGMA_png_error(png_ptr, "Z_OK on Z_FINISH with output space");
...
void
MAGMA_png_write_IEND(png_structrp png_ptr)
{
   ((void)0);

   png_write_complete_chunk(png_ptr, (((png_uint_32)(73) << (24)) | ((png_uint_32)(69) << (16)) | ((png_uint_32)(78) << (8)) | ((png_uint_32)(68) << (0))), ((void*)0), 0);
   png_ptr->mode |= 0x10U;
}
...
void
MAGMA_png_write_gAMA_fixed(png_structrp png_ptr, png_fixed_point file_gamma)
{
   png_byte buf[4];
   ...
   MAGMA_png_save_uint_32(buf, (png_uint_32)file_gamma);
   png_write_complete_chunk(png_ptr, (((png_uint_32)(103) << (24)) | ((png_uint_32)(65) << (16)) | ((png_uint_32)(77) << (8)) | ((png_uint_32)(65) << (0))), buf, 4);
}
...
void
MAGMA_png_write_sRGB(png_structrp png_ptr, int srgb_intent)
{
   png_byte buf[1];
   ...
   png_write_complete_chunk(png_ptr, (((png_uint_32)(115) << (24)) | ((png_uint_32)(82) << (16)) | ((png_uint_32)(71) << (8)) | ((png_uint_32)(66) << (0))), buf, 1);
}
...
void
MAGMA_png_write_iCCP(png_structrp png_ptr, png_const_charp name,
    png_const_bytep profile)
{
   ...
   if (profile == ((void*)0))
      MAGMA_png_error(png_ptr, "No profile for iCCP chunk");

   profile_len = (((png_uint_32)(*(profile)) << 24) + ((png_uint_32)(*((profile) + 1)) << 16) + ((png_uint_32)(*((profile) + 2)) << 8) + ((png_uint_32)(*((profile) + 3))));

   if (profile_len < 132)
      MAGMA_png_error(png_ptr, "ICC profile too short");

   temp = (png_uint_32) (*(profile+8));
   if (temp > 3 && (profile_len & 0x03))
      MAGMA_png_error(png_ptr, "ICC profile length invalid (not a multiple of 4)");

   {
      ...
      if (profile_len != embedded_profile_len)
         MAGMA_png_error(png_ptr, "Profile length does not match profile");
   }

   name_len = MAGMA_png_check_keyword(png_ptr, name, new_name);

   if (name_len == 0)
      MAGMA_png_error(png_ptr, "iCCP: invalid keyword");
   ...
   MAGMA_png_write_chunk_data(png_ptr, new_name, name_len);
...
void
MAGMA_png_write_sPLT(png_structrp png_ptr, png_const_sPLT_tp spalette)
{
   png_uint_32 name_len;
   ...
   name_len = MAGMA_png_check_keyword(png_ptr, spalette->name, new_name);

   if (name_len == 0)
      MAGMA_png_error(png_ptr, "sPLT: invalid keyword");


   png_write_chunk_header(png_ptr, (((png_uint_32)(115) << (24)) | ((png_uint_32)(80) << (16)) | ((png_uint_32)(76) << (8)) | ((png_uint_32)(84) << (0))),
       (png_uint_32)(name_len + 2 + palette_size));

   MAGMA_png_write_chunk_data(png_ptr, (png_bytep)new_name, (size_t)(name_len + 1));

   MAGMA_png_write_chunk_data(png_ptr, &spalette->depth, 1);
   ...
   for (ep = spalette->entries; ep<spalette->entries + spalette->nentries; ep++)
   {
      if (spalette->depth == 8)
      {
         ...
         MAGMA_png_save_uint_16(entrybuf + 4, ep->frequency);
      }

      else
      {
         MAGMA_png_save_uint_16(entrybuf + 0, ep->red);
         MAGMA_png_save_uint_16(entrybuf + 2, ep->green);
         MAGMA_png_save_uint_16(entrybuf + 4, ep->blue);
         MAGMA_png_save_uint_16(entrybuf + 6, ep->alpha);
         MAGMA_png_save_uint_16(entrybuf + 8, ep->frequency);
      }

      MAGMA_png_write_chunk_data(png_ptr, entrybuf, entry_size);
   }
# 1256 "/benchmark/project/libpng/repo/pngwutil.c"
   MAGMA_png_write_chunk_end(png_ptr);
}
...
void
MAGMA_png_write_sBIT(png_structrp png_ptr, png_const_color_8p sbit, int color_type)
{
   png_byte buf[4];
   size_t size;
   ...
   if ((color_type & 2) != 0)
   {
      ...
      {
         MAGMA_png_warning(png_ptr, "Invalid sBIT depth specified");
         return;
      }
...
void
MAGMA_png_write_cHRM_fixed(png_structrp png_ptr, const png_xy *xy)
{
   png_byte buf[32];
   ...
   MAGMA_png_save_int_32(buf, xy->whitex);
   MAGMA_png_save_int_32(buf + 4, xy->whitey);

   MAGMA_png_save_int_32(buf + 8, xy->redx);
   MAGMA_png_save_int_32(buf + 12, xy->redy);

   MAGMA_png_save_int_32(buf + 16, xy->greenx);
   MAGMA_png_save_int_32(buf + 20, xy->greeny);

   MAGMA_png_save_int_32(buf + 24, xy->bluex);
   MAGMA_png_save_int_32(buf + 28, xy->bluey);
...
void
MAGMA_png_write_tRNS(png_structrp png_ptr, png_const_bytep trans_alpha,
    png_const_color_16p tran, int num_trans, int color_type)
{
   ...
   else if (color_type == 0)
   {
      ...
      MAGMA_png_save_uint_16(buf, tran->gray);
   ...
   else if (color_type == (2))
   {
      ...
      MAGMA_png_save_uint_16(buf, tran->red);
      MAGMA_png_save_uint_16(buf + 2, tran->green);
      MAGMA_png_save_uint_16(buf + 4, tran->blue);
   ...
   {
      MAGMA_png_app_warning(png_ptr, "Can't write tRNS with an alpha channel");
   }
}
...
void
MAGMA_png_write_bKGD(png_structrp png_ptr, png_const_color_16p back, int color_type)
{
   png_byte buf[6];
   ...
   if (color_type == (2 | 1))
   {
      ...
      {
         MAGMA_png_warning(png_ptr, "Invalid background palette index");
         return;
      }
   ...
   {
      MAGMA_png_save_uint_16(buf, back->red);
      MAGMA_png_save_uint_16(buf + 2, back->green);
      MAGMA_png_save_uint_16(buf + 4, back->blue);
   ...
   else
   {
      ...
      MAGMA_png_save_uint_16(buf, back->gray);
...
void
MAGMA_png_write_eXIf(png_structrp png_ptr, png_bytep exif, int num_exif)
{
   int i;
   png_byte buf[1];
   ...
   png_write_chunk_header(png_ptr, (((png_uint_32)(101) << (24)) | ((png_uint_32)(88) << (16)) | ((png_uint_32)(73) << (8)) | ((png_uint_32)(102) << (0))), (png_uint_32)(num_exif));

   for (i = 0; i < num_exif; i++)
   {
      buf[0] = exif[i];
      MAGMA_png_write_chunk_data(png_ptr, buf, 1);
   }
...
void
MAGMA_png_write_hIST(png_structrp png_ptr, png_const_uint_16p hist, int num_hist)
{
   int i;
   png_byte buf[3];
   ...
   if (num_hist > (int)png_ptr->num_palette)
   {
      ...
      MAGMA_png_warning(png_ptr, "Invalid number of histogram entries specified");
      return;
   }
   ...
   {
      MAGMA_png_save_uint_16(buf, hist[i]);
      MAGMA_png_write_chunk_data(png_ptr, buf, 2);
   }
...
void
MAGMA_png_write_tEXt(png_structrp png_ptr, png_const_charp key, png_const_charp text,
    size_t text_len)
{
   png_uint_32 key_len;
   png_byte new_key[80];
   ...
   key_len = MAGMA_png_check_keyword(png_ptr, key, new_key);

   if (key_len == 0)
      MAGMA_png_error(png_ptr, "tEXt: invalid keyword");
   ...
   if (text_len > ((png_uint_32)0x7fffffffL) - (key_len+1))
      MAGMA_png_error(png_ptr, "tEXt: text too long");
   ...
   MAGMA_png_write_chunk_data(png_ptr, new_key, key_len + 1);

   if (text_len != 0)
      MAGMA_png_write_chunk_data(png_ptr, (png_const_bytep)text, text_len);
...
void
MAGMA_png_write_zTXt(png_structrp png_ptr, png_const_charp key, png_const_charp text,
    int compression)
{
   png_uint_32 key_len;
   png_byte new_key[81];
   ...
   if (compression == -1)
   {
      MAGMA_png_write_tEXt(png_ptr, key, text, 0);
      return;
   }

   if (compression != 0)
      MAGMA_png_error(png_ptr, "zTXt: invalid compression type");

   key_len = MAGMA_png_check_keyword(png_ptr, key, new_key);

   if (key_len == 0)
      MAGMA_png_error(png_ptr, "zTXt: invalid keyword");
   ...
   MAGMA_png_write_chunk_data(png_ptr, new_key, key_len);
...
void
MAGMA_png_write_iTXt(png_structrp png_ptr, int compression, png_const_charp key,
    png_const_charp lang, png_const_charp lang_key, png_const_charp text)
{
   ...
   if (key_len == 0)
      MAGMA_png_error(png_ptr, "iTXt: invalid keyword");
   ...
   switch (compression)
   {
      ...
      default:
         MAGMA_png_error(png_ptr, "iTXt: invalid compression");
   }

   new_key[++key_len] = 0;
   ++key_len;
# 1669 "/benchmark/project/libpng/repo/pngwutil.c"
   if (lang == ((void*)0)) lang = "";
   ...
   else
   {
      if (comp.input_len > ((png_uint_32)0x7fffffffL)-prefix_len)
         MAGMA_png_error(png_ptr, "iTXt: uncompressed text too long");
   ...
   MAGMA_png_write_chunk_data(png_ptr, (png_const_bytep)lang, lang_len);

   MAGMA_png_write_chunk_data(png_ptr, (png_const_bytep)lang_key, lang_key_len);

   if (compression != 0)
      png_write_compressed_data_out(png_ptr, &comp);

   else
      MAGMA_png_write_chunk_data(png_ptr, (png_const_bytep)text, comp.output_len);
...
void
MAGMA_png_write_oFFs(png_structrp png_ptr, png_int_32 x_offset, png_int_32 y_offset,
    int unit_type)
{
   png_byte buf[9];
   ...
   if (unit_type >= 2)
      MAGMA_png_warning(png_ptr, "Unrecognized unit type for oFFs chunk");

   MAGMA_png_save_int_32(buf, x_offset);
   MAGMA_png_save_int_32(buf + 4, y_offset);
   buf[8] = (png_byte)unit_type;

   png_write_complete_chunk(png_ptr, (((png_uint_32)(111) << (24)) | ((png_uint_32)(70) << (16)) | ((png_uint_32)(70) << (8)) | ((png_uint_32)(115) << (0))), buf, 9);
}



void
MAGMA_png_write_pCAL(png_structrp png_ptr, png_charp purpose, png_int_32 X0,
    ...
    png_charpp params)
{
   ...
   if (type >= 4)
      MAGMA_png_error(png_ptr, "Unrecognized equation type for pCAL chunk");

   purpose_len = MAGMA_png_check_keyword(png_ptr, purpose, new_purpose);

   if (purpose_len == 0)
      MAGMA_png_error(png_ptr, "pCAL: invalid keyword");
   ...
   params_len = (png_size_tp)MAGMA_png_malloc(png_ptr,
   ...
   MAGMA_png_write_chunk_data(png_ptr, new_purpose, purpose_len);
   MAGMA_png_save_int_32(buf, X0);
   MAGMA_png_save_int_32(buf + 4, X1);
   buf[8] = (png_byte)type;
   buf[9] = (png_byte)nparams;
   MAGMA_png_write_chunk_data(png_ptr, buf, 10);
   MAGMA_png_write_chunk_data(png_ptr, (png_const_bytep)units, (size_t)units_len);

   for (i = 0; i < nparams; i++)
   {
      MAGMA_png_write_chunk_data(png_ptr, (png_const_bytep)params[i], params_len[i]);
   }

   MAGMA_png_free(png_ptr, params_len);
   MAGMA_png_write_chunk_end(png_ptr);
}
...
void
MAGMA_png_write_sCAL_s(png_structrp png_ptr, int unit, png_const_charp width,
    png_const_charp height)
{
   ...
   if (total_len > 64)
   {
      MAGMA_png_warning(png_ptr, "Can't write sCAL (buffer too small)");
      return;
   }
...
void
MAGMA_png_write_pHYs(png_structrp png_ptr, png_uint_32 x_pixels_per_unit,
    png_uint_32 y_pixels_per_unit,
    int unit_type)
{
   png_byte buf[9];
   ...
   if (unit_type >= 2)
      MAGMA_png_warning(png_ptr, "Unrecognized unit type for pHYs chunk");

   MAGMA_png_save_uint_32(buf, x_pixels_per_unit);
   MAGMA_png_save_uint_32(buf + 4, y_pixels_per_unit);
   buf[8] = (png_byte)unit_type;

   png_write_complete_chunk(png_ptr, (((png_uint_32)(112) << (24)) | ((png_uint_32)(72) << (16)) | ((png_uint_32)(89) << (8)) | ((png_uint_32)(115) << (0))), buf, 9);
}
...
void
MAGMA_png_write_tIME(png_structrp png_ptr, png_const_timep mod_time)
{
   png_byte buf[7];
   ...
   {
      MAGMA_png_warning(png_ptr, "Invalid time specified for tIME chunk");
      return;
   }

   MAGMA_png_save_uint_16(buf, mod_time->year);
   ...
   png_write_complete_chunk(png_ptr, (((png_uint_32)(116) << (24)) | ((png_uint_32)(73) << (16)) | ((png_uint_32)(77) << (8)) | ((png_uint_32)(69) << (0))), buf, 7);
}



void
MAGMA_png_write_start_row(png_structrp png_ptr)
{
   ...
   png_ptr->row_buf = (MAGMA_png_malloc(png_ptr, buf_size));
   ...
   if ((filters & (0x40 | 0x20 | 0x80)) != 0)
      png_ptr->prev_row = (MAGMA_png_calloc(png_ptr, buf_size));
...
void
MAGMA_png_write_finish_row(png_structrp png_ptr)
{
   ...
   MAGMA_png_compress_IDAT(png_ptr, ((void*)0), 0, 4);
}
# 2095 "/benchmark/project/libpng/repo/pngwutil.c"
void
MAGMA_png_do_write_interlace(png_row_infop row_info, png_bytep row, int pass)
{
...
void
MAGMA_png_write_find_filter(png_structrp png_ptr, png_row_infop row_info)
{
   ...
   mins = ((size_t)(-1)) - 256 ;
# 2599 "/benchmark/project/libpng/repo/pngwutil.c"
    ...
    size_t full_row_length )
{
   ...
   MAGMA_png_compress_IDAT(png_ptr, filtered_row, full_row_length, 0);
